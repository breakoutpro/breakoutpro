      ...
      return (
        <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",display:"flex",alignItems:"center",justifyContent:"center",padding:24}}>
          <div style={{textAlign:"center",maxWidth:300}}>
            ...
            <div style={{fontSize:10,color:T2,marginBottom:14,lineHeight:1.6}}>This screen ran into an error. You can go back and try again.</div>
            <div style={{background:"rgba(239,68,68,0.08)",border:"1px solid rgba(239,68,68,0.25)",borderRadius:10,padding:"10px 12px",marginBottom:20,textAlign:"left"}}>
              <div style={{fontSize:8,color:R,fontWeight:700,marginBottom:4}}>ERROR DETAIL</div>
              <div style={{fontSize:9,color:T2,fontFamily:"monospace",wordBreak:"break-word"}}>{this.state.errorMsg}</div>
            </div>
