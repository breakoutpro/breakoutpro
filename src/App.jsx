...
import AIBriefing   from "./screens/AIBriefing";
import OIChain      from "./screens/OIChain";
...
export default function App() {
  ...
  var MORE_SCREENS = ["global","heatmap","fiidii","journal","challenges","sub","tools","candle","chart","detector","analysis","scalper","quiz","briefing","oi"];
  useEffect(function(){
    function onBack(e){
      e.preventDefault();
  ...
  function renderScreen(){
    return (
      <Suspense fallback={<Loader/>}>
        {tab=="home"     ? <HomeScreen setTab={setTab} nifty={hp.nifty} sensex={hp.sensex} bankNifty={hp.bankNifty} midcap={hp.midcap} stocks={hp.stocks} news={hp.news} briefing={hp.briefing} briefingLoading={hp.briefingLoading} onBriefing={hp.onBriefing} user={hp.user} setTab={hp.setTab} glTab={hp.glTab} setGlTab={hp.setGlTab}/> : null}
        ...
        {tab=="briefing","oi" ? <AIBriefing/> : null}
