...
function MiniChart(props){
  var d=props.d||[],col=props.col||T2,w=props.w||60,h=props.h||28;
  ...
  return(
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{background:BG,padding:"12px 16px",borderBottom:"1px solid "+BD}}>
        ...
        <div style={{background:"rgba(245,158,11,0.08)",border:"1px solid rgba(245,158,11,0.25)",borderRadius:12,padding:"8px 16px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      ...
      <div style={{padding:"12px 16px 0"}}>
        ...
        <div style={{background:"#130F00",border:"1px solid rgba(245,158,11,0.25)",borderRadius:18,padding:16,marginBottom:12,boxShadow:"0 4px 20px rgba(245,158,11,0.06)"}}>
        ...
        <div style={{background:CARD,border:"1px solid "+BD,borderRadius:16,padding:"12px 16px",marginBottom:12}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
            ...
            <span style={{fontSize:12,fontWeight:800,color:BLUE,background:"rgba(245,158,11,0.12)",border:"1px solid rgba(245,158,11,0.3)",padding:"4px 8px",borderRadius:5}}>SAMPLE</span>
          </div>
        ...
        {/* 6. AI Trade Setup */}
        <div style={{background:"#0E0820",border:"1px solid rgba(124,58,237,0.25)",borderRadius:16,padding:"12px 16px",marginBottom:12}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
