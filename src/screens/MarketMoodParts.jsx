  ...
  return (
    <div style={{position:"relative",width:110,height:64}}>
      <svg width="110" height="58" viewBox="0 0 110 58">
        <path d="M 9.0 55.0 A 46 46 0 0 1 32.0 15.2" stroke={MT.RED} strokeWidth="9" fill="none" strokeLinecap="round"/>
        <path d="M 32.0 15.2 A 46 46 0 0 1 78.0 15.2" stroke={MT.WARN} strokeWidth="9" fill="none"/>
        <path d="M 78.0 15.2 A 46 46 0 0 1 101.0 55.0" stroke={MT.GREEN} strokeWidth="9" fill="none" strokeLinecap="round"/>
        <g transform={"rotate("+needleRot+" 55 55)"}>
          <line x1="55" y1="55" x2="15" y2="55" stroke={MT.T1} strokeWidth="2" strokeLinecap="round"/>
        </g>
        <circle cx="55" cy="55" r="3.5" fill={MT.T1}/>
      </svg>
      <div style={{display:"flex",justifyContent:"space-between",width:110,fontSize:7,color:MT.T3,fontWeight:700,marginTop:1}}>
