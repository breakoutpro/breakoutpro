      ...
      <div style={{padding:16}}>
        {tab=="dash"?(
          <div>
            ...
            {/* Daily Hub entry */}
            <button onClick={function(){props.setTab&&props.setTab("optsellhub");}} style={{width:"100%",background:theme.c.card,border:"1px solid rgba(37,99,235,0.3)",borderRadius:12,padding:"12px 24px",marginBottom:16,cursor:"pointer",fontFamily:"inherit",textAlign:"left",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div>
