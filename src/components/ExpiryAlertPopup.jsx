...
export default function ExpiryAlertPopup(props){
  ...
  var BD2 = theme.c.border2, CARD2 = theme.c.card2, GOLD = theme.c.gold, T2 = theme.c.text2, T3 = theme.c.text3;
  ...
  return (
    <div style={{position:"fixed",top:14,left:0,right:0,zIndex:9999,padding:"0 14px",maxWidth:(props.maxWidth||430),margin:"0 auto",pointerEvents:"none"}}>
      <div onClick={function(){ if(props.onOpen) props.onOpen(); setAlert(null); }} style={{background:"linear-gradient(135deg,#0F1629,#101318)",border:"1px solid "+BLUE,borderRadius:14,padding:"12px 13px",display:"flex",alignItems:"center",gap:11,boxShadow:"0 8px 30px rgba(0,0,0,0.6)",pointerEvents:"auto",cursor:"pointer"}}>
