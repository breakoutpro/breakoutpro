...
export default function SettingsScreen(props) {
  ...
  var BLUE = theme.c.blue, G = theme.c.up, R = theme.c.down, BLUE = theme.c.gold;
      ...
      <div style={{background:theme.c.card,border:"1px solid rgba(59,130,246,0.15)",borderRadius:16,margin:"16px 16px 0",padding:16,display:"flex",alignItems:"center",gap:12}}>
        ...
        <div style={{flex:1}}>
          ...
          <div style={{marginTop:8}}>
            {isPrem
              ? <span style={{background:"rgba(245,158,11,0.15)",color:BLUE,borderRadius:20,padding:"4px 12px",fontSize:12,fontWeight:700,border:"1px solid rgba(245,158,11,0.3)"}}>PRO Member</span>
