...
export default function EquityHomeDesktop(props){
  ...
  var responsive = useResponsive(); // TEMPORARY - for the debug overlay only
  var workspaceRef = useRef(null); // TEMPORARY - for the debug overlay only
  ...
  return (
    <div ref={workspaceRef} style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",color:T1,overflowX:"hidden",display:"flex",flexDirection:"column"}}>
      <DebugOverlay componentName="EquityHomeDesktop.jsx" breakpoint={responsive.breakpoint} workspaceRef={workspaceRef}/>
      ...
      <div style={{flex:1,display:"flex",minHeight:0,width:"100%"}}>
        ...
        <div style={{flex:1,minWidth:0,padding:"12px 16px",overflowY:"auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"260px 1fr",gap:10,marginBottom:10}}>
            <div style={{background:CARD2,border:"1px solid "+BD,borderRadius:10,padding:"8px 12px"}}>
          ...
          <div style={{background:CARD2,border:"1px solid "+BD,borderRadius:10,padding:"8px 12px",marginBottom:10}}>
