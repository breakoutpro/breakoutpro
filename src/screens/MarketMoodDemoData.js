...
export var DEMO_DATA = {
  indices: {
    NIFTY: idx(24105.30, -0.45),
    BANKNIFTY: idx(52341.15, -0.62),
    SENSEX: idx(79648.17, -0.48),
    VIX: idx(12.85, 3.21)
  },
  fiiDii: "DEMO",
  sectors: {
...
// F&O Trader Snapshot - PCR, Max Pain, and FII derivatives flow have no real
// data source anywhere in this app (no options-chain API, no FII/DII
// real-time feed exists - confirmed across many earlier rounds). Demo only,
// clearly labeled wherever shown. VIX reuses the same real/demo value as
// the rest of the page, not a separate number.
export var DEMO_FNO = {
  pcr: 1.18,
  pcrLabel: "Bullish",
  maxPain: 24500,
