    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:40}}>
      ...
      <div style={{display:"flex",gap:6,overflowX:"auto",padding:"14px 14px 10px",position:"sticky",top:57,background:BG,zIndex:9}}>
        {TABS.map(function(t){
          var act=tab==t[0];
          return (
            <button key={t[0]} onClick={function(){setTab(t[0]);}} style={{background:act?BLUE:"rgba(255,255,255,0.05)",border:"1px solid "+(act?BLUE:BD),borderRadius:18,padding:"6px 13px",color:act?"#04060D":T2,fontSize:11,fontWeight:act?800:600,cursor:"pointer",fontFamily:"inherit",flexShrink:0,whiteSpace:"nowrap"}}>{t[1]}</button>
          );
        })}
      </div>
