      ...
      {activeTab=="stocks"?(
        <div style={{margin:"12px 16px 0"}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:8}}>
            <span style={{fontSize:12,fontWeight:800,color:GOLD,background:"rgba(212,175,55,0.12)",border:"1px solid rgba(212,175,55,0.3)",padding:"4px 8px",borderRadius:5,letterSpacing:0.5}}>DEMO DATA</span>
      ...
      {activeTab=="indices"?(
        <div style={{display:"flex",justifyContent:"flex-end",padding:"4px 16px 0"}}>
          <div style={{background:liveStatus=="live"?"rgba(0,200,83,0.15)":liveStatus=="closed"?"rgba(255,255,255,0.06)":"rgba(245,158,11,0.1)",border:"1px solid "+(liveStatus=="live"?"rgba(0,200,83,0.3)":liveStatus=="closed"?"rgba(255,255,255,0.1)":"rgba(245,158,11,0.25)"),borderRadius:20,padding:"4px 8px",display:"flex",alignItems:"center",gap:4}}>
            ...
            <span style={{fontSize:12,fontWeight:700,color:liveStatus=="live"?G:liveStatus=="closed"?T2:GOLD}}>{liveStatus=="live"?"LIVE":liveStatus=="closed"?"MARKET CLOSED":"CONNECTING"}</span>
          </div>
        </div>
      ):null}
      {activeTab=="indices"?(
      ...
      {activeTab=="commodities"?(
        <div style={{padding:"12px 16px"}}>
          <div style={{background:"rgba(245,158,11,0.06)",border:"1px solid rgba(245,158,11,0.2)",borderRadius:10,padding:"8px 12px",marginBottom:12}}>
            <div style={{fontSize:12,color:GOLD}}>MCX Commodities  Demo data. Live data on market days.</div>
          </div>
              ...
              return (
                <div key={s.sym} style={{display:"flex",alignItems:"center",gap:12,padding:"12px 16px",borderBottom:"1px solid "+BD,cursor:"pointer"}} onClick={function(){setSelCom(s);}}>
                  <div style={{width:36,height:36,borderRadius:10,background:"rgba(245,158,11,0.1)",border:"1px solid rgba(245,158,11,0.2)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                    <span style={{fontSize:12,fontWeight:800,color:GOLD}}>{s.sym.slice(0,3)}</span>
                  </div>
                  <div style={{flex:1}}>
