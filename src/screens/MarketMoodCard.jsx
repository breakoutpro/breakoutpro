    ...
    <div style={{padding:"14px 14px 0"}}>
      <div onClick={function(){setOpen(true);}} style={{background:CARD,border:"1px solid "+BD,borderRadius:16,padding:15,cursor:"pointer"}}>
        ...
        <div>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",borderTop:"1px solid "+BD,paddingTop:9}}>
            <span style={{fontSize:8.5,color:T3}}>Educational Market Observation Only. Not Investment Advice.</span>
            <span style={{fontSize:11,color:CYAN,fontWeight:700}}>Details &#8594;</span>
          </div>
        </div>
        )}
