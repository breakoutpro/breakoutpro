...
export function getAlertFeed(watch){
  ...
  var samples=[
    {sym:watch[0].sym,type:"breakout",time:"10:24 AM"},
    {sym:watch[0].sym,type:"volspike",time:"10:18 AM"}
  ];
  if(watch[1]) samples.push({sym:watch[1].sym,type:"rsi",time:"09:58 AM"});
  if(watch[2]) samples.push({sym:watch[2].sym,type:"oichange",time:"09:41 AM"});
  if(watch[1]) samples.push({sym:watch[1].sym,type:"resistancetouch",time:"09:32 AM"});
  return samples;
}
