...
export default function PulseIndexDetail(props){
  ...
  T1=theme.c.text1; DB=theme.c.bg; CB=theme.c.card; BD=theme.c.border; G2=theme.c.up; R=theme.c.down; BLUE=theme.c.gold; BLUE=theme.c.blue; T2=theme.c.text2; T3=theme.c.text3;
