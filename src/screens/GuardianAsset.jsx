  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:40}}>
      ...
      <div style={{padding:14}}>
        ...
        <div style={{background:(c.up?"rgba(0,143,57,0.08)":"rgba(220,38,38,0.08)"),border:"1px solid "+(c.up?"rgba(34,197,94,0.25)":"rgba(239,68,68,0.25)"),borderRadius:16,padding:15,marginBottom:16}}>
          ...
          <div style={{background:CARD,border:"1px solid "+BD,borderRadius:13,padding:13}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:9}}>
              <div style={{display:"flex",alignItems:"center",gap:9}}>
                <div onClick={function(){setCandlePopup(candle);}} style={{width:40,height:40,background:theme.c.card2,border:"1px solid "+BD,borderRadius:9,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0}}>
        ...
        <Sec t="AI EDUCATIONAL SUMMARY">
          <div style={{background:theme.c.card,border:"1px solid rgba(79,140,255,0.22)",borderRadius:13,padding:14}}>
        ...
        <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:10,padding:12}}>
          <div style={{fontSize:8.5,color:theme.c.warn,lineHeight:1.55}}>Educational Market Observation Only. This page organizes observed market structure using publicly available market data. It does not provide investment advice, trading recommendations, predictions, or buy/sell signals.</div>
        </div>
      </div>
        ...
        <div onClick={function(){setCandlePopup(null);}} style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.7)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
          <div onClick={function(e){e.stopPropagation();}} style={{background:CARD,border:"1px solid "+BD,borderRadius:16,padding:18,maxWidth:320,width:"100%"}}>
            <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:14}}>
              <div style={{width:52,height:52,background:theme.c.card2,border:"1px solid "+BD,borderRadius:11,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
            ...
            <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:9,padding:9,marginTop:6}}>
              <div style={{fontSize:8.5,color:theme.c.warn,lineHeight:1.5}}>Educational Market Observation Only. Not Investment Advice.</div>
            </div>
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.7)",zIndex:50,display:"flex",alignItems:"flex-end"}} onClick={function(){setShowBell(false);}}>
          <div onClick={function(e){e.stopPropagation();}} style={{background:theme.c.bgAlt,borderTop:"1px solid "+BD,borderRadius:"18px 18px 0 0",width:"100%",maxHeight:"80vh",overflowY:"auto",padding:16,boxSizing:"border-box"}}>
            ...
            <div style={{marginBottom:14}}>
              <div style={{fontSize:9,fontWeight:800,color:T2,marginBottom:8,letterSpacing:0.5}}>ALERT MODE</div>
              <div style={{display:"flex",gap:6}}>
                {[["off","Off","&#128277;"],["normal","Normal","&#128276;"],["voice","Voice","&#128266;"],["priority","Priority","&#128680;"]].map(function(m){
                  var on=alertMode==m[0];
                  return (
                    <button key={m[0]} onClick={function(){pickMode(m[0]);}} style={{flex:1,background:on?"rgba(79,140,255,0.15)":"rgba(255,255,255,0.05)",border:"1px solid "+(on?BLUE:BD),borderRadius:10,padding:"9px 4px",cursor:"pointer",fontFamily:"inherit"}}>
                      <div style={{fontSize:13}} dangerouslySetInnerHTML={{__html:m[2]}}/>
                      <div style={{fontSize:8.5,fontWeight:on?800:600,color:on?BLUE:T2,marginTop:3}}>{m[1]}</div>
                    </button>
                  );
                })}
              </div>
              <div style={{fontSize:8,color:T3,marginTop:7,lineHeight:1.5}}>
