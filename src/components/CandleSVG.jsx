...
function C(props){
  ...
  return (
    <g>
      ...
      <rect x={x-w/2} y={props.top} width={w} height={Math.max(1,props.bot-props.top)} fill={props.filled?props.col:theme.c.card2} stroke={props.col} strokeWidth="1.4"/>
    </g>
  );
}
...
export default function CandleSVG(props){
  var theme = useTheme(); // reuses the existing ThemeProvider - no new theme system
  DOJI=theme.c.text2; DOWN=theme.c.down;
  // Theme-sourced overrides - shadow the module-level hardcoded fallbacks above.
  var NEUTRAL = theme.c.text2; UP=theme.c.up;
