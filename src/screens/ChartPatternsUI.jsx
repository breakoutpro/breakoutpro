    ...
    <div style={{background:CB,border:"1px solid "+BD,borderRadius:16,padding:16,marginBottom:8,cursor:"pointer"}} onClick={props.onClick}>
      <div style={{display:"flex",alignItems:"flex-start",gap:12}}>
        ...
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:8}}>
          <button onClick={function(e){e.stopPropagation();props.onFav();}} style={{background:"none",border:"none",cursor:"pointer",fontSize:16,color:isFav?GOLD:T2,padding:4}}>{isFav?"":""}</button>
