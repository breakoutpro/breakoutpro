...
export function ExploreShortcuts(props){
  ...
  return (
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:18}}>
      <div onClick={function(){setTab("learn");}} style={{background:CARD,border:"1px solid "+BD,borderRadius:16,padding:"14px",cursor:"pointer"}}>
        <span style={{fontSize:18}}>&#128218;</span>
        <div style={{fontSize:11,fontWeight:700,color:T1,marginTop:8}}>Learn</div>
        <div style={{fontSize:8.5,color:T3,marginTop:2}}>Patterns, strategies &amp; more</div>
      </div>
      <div onClick={function(){setTab("ai");}} style={{background:CARD,border:"1px solid "+BD,borderRadius:16,padding:"14px",cursor:"pointer"}}>
        <span style={{fontSize:18}}>&#129302;</span>
        <div style={{fontSize:11,fontWeight:700,color:T1,marginTop:8}}>AI Assistant</div>
        <div style={{fontSize:8.5,color:T3,marginTop:2}}>Ask anything about markets</div>
      </div>
    </div>
  );
}
