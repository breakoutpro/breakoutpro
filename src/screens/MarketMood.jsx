  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{padding:"18px " + (responsive.shell.pad>16?responsive.shell.pad:16) + "px 40px",maxWidth:responsive.shell.centerMax,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        {showLoading ? (
          <div style={{padding:"32px 0",textAlign:"center",color:MT.T2,fontSize:12}}>Loading market mood...</div>
        ) : showOffline ? (
        ...
        <button onClick={onVoice} style={{width:"100%",background:MT.BLUE,border:"none",borderRadius:13,padding:16,color:"#fff",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"inherit",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"center",gap:8,minHeight:44}}>
