...
export var SECTIONS = [
  {name:"Market Tools", items:[
    {id:"guardian",   title:"AI Market Guardian",desc:"Smart observation and educational alerts", kind:"tab", tab:"guardian", pro:true, live:true},
  ...
  {name:"Stock Scanners", items:[
    {id:"breakout",   title:"Breakout Scanner",      desc:"Stocks breaking key resistance (real data)", kind:"tab", tab:"breakoutscan", live:true},
    {id:"breakdown",  title:"Breakdown Scanner",     desc:"Stocks breaking key support (real data)", kind:"tab", tab:"breakoutscan", live:true},
    {id:"volspike",   title:"Volume Spike Scanner",  desc:"Unusual volume surges (real data)", kind:"tab", tab:"breakoutscan", live:true},
    {id:"gap",        title:"Gap Up / Gap Down",     desc:"Opening gap movers", kind:"tab", tab:"scan"},
    {id:"rsi",        title:"RSI Scanner",           desc:"Overbought and oversold zones", kind:"tab", tab:"scan"},
    {id:"orb",        title:"ORB Scanner",           desc:"Opening range breakouts", kind:"tab", tab:"scan"},
    {id:"delivery",   title:"Delivery Volume Scanner",desc:"High delivery percentage", kind:"tab", tab:"scan"},
    {id:"high52",     title:"52 Week High Scanner",  desc:"Stocks at yearly highs", kind:"tab", tab:"scan"},
    {id:"low52",      title:"52 Week Low Scanner",   desc:"Stocks at yearly lows", kind:"tab", tab:"scan"}
  ]},
  {name:"Options Scanners", pro:true, items:[
    ...
    {id:"pcr",        title:"PCR Scanner",           desc:"Put-Call Ratio extremes", kind:"tab", tab:"optionsintelpro", pro:true},
    {id:"maxpain",    title:"Max Pain Scanner",      desc:"Max pain by expiry", kind:"tab", tab:"optionsintelpro", pro:true},
    {id:"callwriting",title:"Call Writing Scanner",  desc:"Heavy call writing strikes", kind:"tab", tab:"optionsintelpro", pro:true},
    {id:"putwriting", title:"Put Writing Scanner",   desc:"Heavy put writing strikes", kind:"tab", tab:"optionsintelpro", pro:true},
    ...
    {id:"ivcrush",    title:"IV Crush Scanner",      desc:"IV crush candidates", kind:"tab", tab:"optionsintelpro", pro:true},
    {id:"greeks",     title:"Greeks Scanner",        desc:"Delta, Gamma, Theta, Vega scan", kind:"tab", tab:"optionsintelpro", pro:true},
  ...
  {name:"Learning", items:[
    ...
    {id:"optlearn",   title:"Options Selling Academy",  desc:"Master option selling, PRO", kind:"tab", tab:"optsell", pro:true}
  ]},
