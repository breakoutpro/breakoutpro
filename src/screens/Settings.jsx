    ...
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      {isAdmin?(
        <div>
          ...
          <div style={{background:CB,border:"1px solid "+BD,borderRadius:14,margin:"0 14px 12px",overflow:"hidden"}}>
            <div onClick={toggleSmartAlerts} style={{padding:"13px 14px",display:"flex",alignItems:"center",gap:10,cursor:"pointer"}}>
              <span style={{fontSize:14}} dangerouslySetInnerHTML={{__html:"&#128276;"}}/>
              <div style={{flex:1}}>
                <div style={{fontSize:12,fontWeight:700,color:T1}}>Smart Alerts</div>
                <div style={{fontSize:9,color:T2}}>The one master switch: scanning, voice, notifications, bubble</div>
              </div>
