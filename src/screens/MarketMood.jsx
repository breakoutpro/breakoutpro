  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{padding:wideLayout?"10px 24px 20px":"16px 24px 32px",maxWidth:1440,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:14,padding:padV,marginBottom:gapV,display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"auto 1fr auto auto":undefined,gap:wideLayout?24:12,alignItems:"center"}}>
        ...
        {usingDemo ? (
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr":undefined,gap:wideLayout?16:8,marginBottom:gapV,alignItems:"start"}}>
            <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:14,padding:padV,marginBottom:wideLayout?0:8}}>
        ...
        {usingDemo ? (
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr 1fr":undefined,gap:wideLayout?16:8,marginBottom:gapV,alignItems:"start"}}>
            <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:14,padding:padV,marginBottom:wideLayout?0:8}}>
        ...
        <div style={{background:MT.CARD2,border:"1px solid "+MT.BD,borderRadius:14,padding:padV,marginBottom:gapV}}>
