              ...
              {(function(){
                ...
                return (
                  <div>
                    ...
                    <div style={{padding:"6px 0"}}><div style={{fontSize:tierCfg.label,color:T3,marginBottom:2}}>Risk Level</div><div style={{fontSize:tierCfg.secondaryText,fontWeight:800,color:riskLevel?riskColor:T3}}>{riskLevel||"N/A"}</div></div>
                    <div style={{padding:"6px 0"}}><div style={{fontSize:tierCfg.label,color:T3,marginBottom:2}}>Trading Bias</div><div style={{fontSize:tierCfg.secondaryText,fontWeight:800,color:biasColor}}>{bi.trend}</div></div>
                    <div style={{padding:"6px 0"}}><div style={{fontSize:tierCfg.label,color:T3,marginBottom:2}}>Events</div><div style={{fontSize:tierCfg.secondaryText,fontWeight:800,color:T1}}>RBI Today</div></div>
                  </div>
                );
              })()}
            </div>
