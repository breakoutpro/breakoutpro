    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",color:T1,overflowX:"hidden",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,display:"flex",minHeight:0,width:"100%"}}>
        ...
        <div style={{flex:1,minWidth:0,padding:"8px 12px",overflowY:"auto"}}>
            ...
            if(!hasRange){
              ...
              rangeContent = (
                <div>
                  ...
                  <div style={{fontSize:9,fontWeight:700,color:stateColor,marginBottom:6}}>{state}</div>
          ...
          {/* MARKET PULSE - broad market context only, deliberately NOT a
              set of full cards (that would just recreate the secondary
              section removed earlier). Market Breadth and FII/DII Flow are
              literal "UNAVAILABLE" strings in api/market-mood-data.js's own
          ...
          {(function(){
            ...
            return (
              <div style={{padding:"0 12px 8px"}}>
                <div style={{background:CARD2+"cc",backdropFilter:"blur(12px)",border:"1px solid "+BD,borderRadius:6,padding:"6px 12px",boxSizing:"border-box",display:"flex",flexWrap:"wrap",gap:"4px 18px",alignItems:"center"}}>
                  <span style={{fontSize:9,fontWeight:800,color:T2,letterSpacing:0.5}}>MARKET PULSE</span>
                  {pulseItems.map(function(it){
                    return (
                      <div key={it.label} style={{display:"flex",alignItems:"center",gap:4,fontSize:9}}>
