  ...
  return (
    <div style={{background:BG,minHeight:"100vh",width:"100%",boxSizing:"border-box",overflowX:"hidden",fontFamily:"'Inter',Arial,sans-serif",paddingBottom:84,color:T1}}>
      ...
      <div style={{width:"100%",boxSizing:"border-box",padding:"7px 9px 0"}}>
        ...
        {/* MARKET STRUCTURE - combines Range Intelligence (real data) +
            Options Intelligence (DEMO, clearly labeled) into one card,
            matching the same "Market Structure" naming/grouping used on
            Desktop/Laptop, per the explicit "same feature names on all
            devices" requirement. Internally stacked (not side-by-side)
            since Mobile is single-column. */}
        {(function(){
          ...
          if(!hasRange){
            rangeBlock = (
              <div style={{marginBottom:8}}>
                <div style={{fontSize:11,fontWeight:800,color:T1,marginBottom:2}}>Range Intelligence</div>
          ...
          return (
            <Card title="Market Structure" icon="&#128202;" onDetails={function(){setTab("rangeintel");}}>
              {rangeBlock}
