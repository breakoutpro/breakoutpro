    ...
    <div>
      ...
      <Sec title="DELIVERY ANALYSIS">
        ...
        <div style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:13}}>
          <div style={{fontSize:11,fontWeight:700,color:CYAN,marginBottom:4}}>Phase: {props.d.delivery.phase}</div>
  ...
  return (
    <div>
      ...
      <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:10,padding:11,marginTop:4}}>
        <div style={{fontSize:9,color:"#F97316",lineHeight:1.5}}>Educational analysis only. Not SEBI registered. Not investment advice. No buy or sell recommendation.</div>
      </div>
    </div>
  );
}
