...
function MoreScreen(props) {
  ...
  var sections = [
    {title:"Charts & Analysis", items:[
      ...
      {label:"Chart Patterns",   id:"patterns", sub:"20 patterns with SVG+Quiz", icon:"P"},
    ...
    {title:"Tools & Learning", items:[
      {label:"Paper Trading",    id:"paper",    sub:"Virtual Rs 5L  Practice free", icon:"P"},
    ...
    {title:"Account", items:[
      ...
      {label:"Morning Pulse",     id:"morning",  sub:"Overnight + AI analysis + Stocks watch", icon:"MP"},
      {label:"Admin Share",       id:"share",    sub:"Share to WhatsApp, Telegram, Twitter", icon:"SH"},
...
export default function App() {
  ...
  var MORE_SCREENS = ["global","heatmap","fiidii","journal","challenges","sub","tools","candle","chart","detector","analysis","scalper","quiz","briefing","oi","alerts","settings","patterns","paper","share","morning"];
  useEffect(function(){
    function onBack(e){
      e.preventDefault();
