...
export function AIBriefingCard(props){
  ...
  return (
    <div style={{
      ...
      <div onClick={function(){setShowMorningPulse(true);}} style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14,cursor:"pointer"}}>
      ...
      <div onClick={function(){setShowMorningPulse(true);}} style={{fontSize:11,color:"#C9D4E5",lineHeight:1.7,marginBottom:14,cursor:"pointer"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
        {[
          ...
          return (
            <div key={r[0]} style={{background:"rgba(255,255,255,0.02)",border:"1px solid "+BD,borderRadius:12,padding:"9px 8px",cursor:"default"}}>
