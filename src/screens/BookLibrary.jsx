...
export default function BookLibrary(props){
  ...
  var GOLD = theme.c.gold, T3 = theme.c.text3; T1=theme.c.text1; UP=theme.c.up;
              ...
              {cat.books.map(function(b){
                ...
                return (
                  <div key={b.id} style={{background:CB,border:"1px solid "+BD,borderRadius:12,padding:14,marginBottom:8}}>
                    ...
                    <div style={{fontSize:11,color:T2,lineHeight:1.6,marginBottom:8}}>{b.summary}</div>
                    ...
                    <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:10}}>
                      ...
                      <span style={{fontSize:9,fontWeight:700,color:T2,background:theme.c.card2,border:"1px solid "+BD,borderRadius:6,padding:"2px 8px"}}>{b.readTime}</span>
                    </div>
