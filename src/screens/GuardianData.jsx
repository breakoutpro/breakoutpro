...
// Category for tab filtering: technical, options, or news.
...
export function getAlertFeed(watch){
  if(!watch||!watch.length) return [];
  var feed=[];
  var w0=watch[0], w1=watch[1]||watch[0], w2=watch[2]||watch[0];
  // technical
  feed.push({sym:w0.sym,type:"breakout",time:"10:24 AM"});
  feed.push({sym:w0.sym,type:"volspike",time:"10:18 AM"});
  feed.push({sym:w1.sym,type:"rsi",time:"09:58 AM"});
  feed.push({sym:w1.sym,type:"resistancetouch",time:"09:32 AM"});
  feed.push({sym:w2.sym,type:"vwapbreak",time:"09:28 AM"});
  // options
  feed.push({sym:w0.sym,type:"oichange",time:"10:05 AM"});
  feed.push({sym:w1.sym,type:"pcr",time:"09:51 AM"});
  feed.push({sym:w2.sym,type:"ivspike",time:"09:40 AM"});
  // news
  feed.push({sym:w0.sym,type:"news",time:"09:20 AM"});
  feed.push({sym:w1.sym,type:"global",time:"09:05 AM"});
  return feed;
}
