...
export default function CommodityHome(props){
  ...
  return(
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      {/* Header */}
      <div style={{background:"#1A1208",padding:"12px 16px",borderBottom:"1px solid "+BD}}>
      ...
      <div style={{padding:"10px 16px 0"}}>
        ...
        {/* 6. AI Trade Setup */}
        <div style={{background:"#0E0820",border:"1px solid rgba(124,58,237,0.25)",borderRadius:16,padding:"12px 14px",marginBottom:12}}>
          <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:10}}>
