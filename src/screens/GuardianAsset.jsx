...
import { updatedAgoLabel } from "../utils/timeAgo";
        ...
        <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:12}}>
          ...
          <div style={{flex:1}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              ...
              <span style={{fontSize:12,fontWeight:800,color:BLUE,background:"rgba(37,99,235,0.12)",padding:"4px 4px",borderRadius:3}}>PRO</span>
        ...
        <div style={{background:(c.up?"rgba(0,143,57,0.08)":"rgba(220,38,38,0.08)"),border:"1px solid "+(c.up?"rgba(34,197,94,0.25)":"rgba(239,68,68,0.25)"),borderRadius:16,padding:16,marginBottom:16}}>
          <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:12}}>
            ...
            <div style={{flex:1}}>
              ...
              {/* SIGNAL AGE */}
              <div style={{fontSize:12,color:T3,marginTop:4,display:"flex",alignItems:"center",gap:4}}><span style={{width:5,height:5,borderRadius:"50%",background:UP,display:"inline-block"}}></span>{updatedAgoLabel(ageSec)}</div>
            </div>
          </div>
