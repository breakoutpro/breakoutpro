  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:40}}>
      <div style={{background:BG,padding:"12px 14px",borderBottom:"1px solid "+BD,display:"flex",alignItems:"center",gap:10,position:"sticky",top:0,zIndex:10}}>
        ...
        <button onClick={function(){setAdding(!adding);}} style={{background:adding?"rgba(255,255,255,0.08)":"rgba(59,130,246,0.15)",border:"1px solid "+(adding?BD:"rgba(59,130,246,0.4)"),borderRadius:9,padding:"7px 12px",color:adding?T2:BLUE,fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>{adding?"Close":"+ Add"}</button>
      </div>
      ...
      <div style={{padding:14}}>
        ...
        <div style={{background:CARD2,border:"1px solid "+BD,borderRadius:12,padding:13,marginTop:14}}>
          <div style={{fontSize:11,fontWeight:700,color:BLUE,marginBottom:6}}>Watchlist Alerts</div>
