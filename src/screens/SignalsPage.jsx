    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:14}}>
              ...
              <div key={s.sym} onClick={function(){setView("patterns");}} style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:12,marginBottom:9,cursor:"pointer"}}>
                <div style={{display:"flex",alignItems:"center",gap:11}}>
                  ...
                  <div style={{textAlign:"right"}}>
                    ...
                    <div style={{fontSize:9,color:CYAN,fontWeight:700,marginTop:2}}>Learn &#8594;</div>
                  </div>
                </div>
              </div>
            );
        ...
        <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:10,padding:11,marginTop:14}}>
          <div style={{fontSize:9,color:"#F97316",lineHeight:1.5}}>BreakoutPro is an educational and market intelligence platform. We show pattern detection and learning content only. We do NOT provide buy, sell, entry, stop loss, or target recommendations. Not SEBI registered as an advisor. Not investment advice.</div>
        </div>
      </div>
    </div>
  );
