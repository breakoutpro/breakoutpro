...
import { TrendingStocksCard, TopBreakoutsCard, AITradeSetupCard, SmartAlertsCard, ExploreShortcuts, AINewsSummaryCard, QuickActionBtn, SectorCard } from "../components/HomeExtras";
    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",paddingBottom:84,color:T1}}>
      ...
      <div style={{padding:"18px 18px 14px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        <div style={{display:"flex",alignItems:"center",gap:9}}>
          ...
          <div style={{fontSize:18,fontWeight:800,letterSpacing:-0.3}}><span style={{color:"#FFFFFF"}}>Breakout</span><span style={{color:PROBLUE}}>Pro</span></div>
        </div>
      ...
      <div style={{padding:"4px 18px 0",display:"flex",justifyContent:"space-between",alignItems:"center",gap:8}}>
        ...
        <button onClick={voiceAlerts.toggleMute} style={{background:CARD,border:"1px solid "+CARDBORDER,borderRadius:"50%",width:32,height:32,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,boxShadow:"0 2px 10px rgba(0,0,0,0.4)"}}>
