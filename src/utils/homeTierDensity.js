...
// it needs).
var TIER_LAYOUT = {
  laptop:    { cardPadding:12, gridGap:12, widgetTitle:14, primaryNumber:18, secondaryText:12, label:11,
               aiBriefHeight:180, breakoutIntelHeight:180, sparklineW:90,  sparklineH:30 },
  desktop:   { cardPadding:14, gridGap:14, widgetTitle:15, primaryNumber:19, secondaryText:12, label:11,
               aiBriefHeight:190, breakoutIntelHeight:190, sparklineW:110, sparklineH:36 },
  ultrawide: { cardPadding:16, gridGap:16, widgetTitle:16, primaryNumber:20, secondaryText:13, label:12,
