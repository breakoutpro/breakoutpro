      ...
      <div style={{flex:1,display:"flex",minHeight:0,width:"100%"}}>
        ...
        <div style={{flex:1,minWidth:0,padding:"24px 32px",overflowY:"auto"}}>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20,paddingBottom:16,borderBottom:"1px solid "+BD2}}>
            <div style={{fontSize:24,fontWeight:900,color:T1}}>{symLabel} <span style={{fontSize:12,fontWeight:700,color:T2,background:CARD2,border:"1px solid "+BD2,borderRadius:6,padding:"3px 8px",marginLeft:10}}>NSE</span></div>
            <MarketMetric
              label="Live Price"
          ...
          <div style={{marginBottom:28,paddingBottom:24,borderBottom:"1px solid "+BD2}}>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:16}}>
              <span style={{fontSize:20,fontWeight:900,color:T1}}>Breakout Intelligence</span>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:32,marginBottom:28,paddingBottom:24,borderBottom:"1px solid "+BD2}}>
            <div>
            ...
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:14}}>
                <div><div style={{fontSize:28,fontWeight:900,color:UP}}>{breadth.adv}</div><div style={{fontSize:12,color:T2}}>Advances</div></div>
                <div><div style={{fontSize:28,fontWeight:900,color:DOWN}}>{breadth.dec}</div><div style={{fontSize:12,color:T2}}>Declines</div></div>
                <div><div style={{fontSize:28,fontWeight:900,color:T2}}>{breadth.unch}</div><div style={{fontSize:12,color:T2}}>Unchanged</div></div>
              </div>
            </div>
