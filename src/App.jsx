...
function MoreScreen(props) {
  ...
  var sections = [
    ...
    {title:"Account & Settings", col:GOLD, items:[
      ...
      {id:"newsstudio", label:"AI News Studio",       sub:"Real headlines, AI sentiment, shareable cards", col:"#3B82F6"},
      {id:"academy",    label:"Trading Academy",       sub:"Structured lessons, quizzes, real progress tracking", col:"#22C55E"},
      {id:"aimentor",   label:"AI Mentor",              sub:"Ask trading questions, offline rule-based answers", col:"#3B82F6"},
      {id:"optionsintelpro", label:"Options Intelligence Pro", sub:"Greeks, Max Pain, PCR, IV Crush - fully offline", col:"#06B6D4"},
      {id:"stockresearchpro", label:"AI Stock Research Pro", sub:"Real technical analysis, honest data-availability", col:"#3B82F6"},
      {id:"marketreplay", label:"Market Replay Simulator", sub:"Replay real historical candles, mark your decisions", col:"#D4AF37"},
      {id:"econcalendar", label:"Economic Calendar Pro", sub:"Educational/Demo Calendar - RBI, Fed, CPI, earnings & more", col:"#D4AF37"},
      {id:"fiidiipro", label:"FII / DII Intelligence Pro", sub:"Educational/Demo Data - flow trends, buy vs sell", col:"#D4AF37"},
      {id:"marketheatmap", label:"Market Heatmap Pro", sub:"Real sector data where available, demo elsewhere", col:"#22C55E"},
      {id:"dividendtracker", label:"Dividend Tracker Pro", sub:"Educational/Demo Dividend Tracker - dates, yield & more", col:"#D4AF37"},
      {id:"globalmarketspro", label:"Global Markets Dashboard Pro", sub:"Real data where available, demo elsewhere", col:"#3B82F6"},
      {id:"alertcenterpro", label:"Alert Center Pro", sub:"Manage your own alert rules, saved locally", col:"#3B82F6"},
...
function DesktopRightSidebar(props){
  var BG="#0A0D12",BD="#1B2330",BD2="#141821",T1="#FFFFFF",T3="#5B6472",BLUE="#4F8CFF";
