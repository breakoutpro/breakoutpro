...
function CandleChart(props) {
  ...
  return (
    <svg width={W} height={H} style={{display:"block",width:"100%"}}>
      ...
      {zones.res1&&zones.res1>=minP&&zones.res1<=maxP?<rect x={0} y={yP(zones.res1)-8} width={W} height={16} fill="rgba(239,68,68,0.06)"/>:null}
      {zones.sup1&&zones.sup1>=minP&&zones.sup1<=maxP?<rect x={0} y={yP(zones.sup1)-8} width={W} height={16} fill="rgba(0,200,83,0.06)"/>:null}
