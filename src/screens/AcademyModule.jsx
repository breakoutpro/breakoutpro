...
export default function AcademyModule(props){
  ...
  return (
    <div style={{padding:14}}>
      <button onClick={onBack} style={{background:"none",border:"none",color:"#3B82F6",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit",padding:0,marginBottom:12}}>&#8592; {at("back_to_module",lang)==="back_to_module"?"Back":at("modules",lang)}</button>
