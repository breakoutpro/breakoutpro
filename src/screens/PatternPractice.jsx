      ...
      <div style={{padding:16}}>
        ...
        {picked?(
          <div style={{marginTop:16}}>
            ...
            <button onClick={next} style={{width:"100%",background:BLUE,border:"none",borderRadius:12,padding:"12px 24px",color:"#04060D",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>Next Pattern &#8594;</button>
          </div>
        ):null}
      </div>
    </div>
      ...
      <div style={{padding:16}}>
        {done?(
          <div style={{textAlign:"center",padding:"32px 12px"}}>
            ...
            <button onClick={props.onBack} style={{marginTop:16,background:BLUE,border:"none",borderRadius:12,padding:"12px 24px",color:"#04060D",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>Back to Pattern</button>
          </div>
        ):(
          <div>
            ...
            {picked!=null?<button onClick={next} style={{width:"100%",background:BLUE,border:"none",borderRadius:12,padding:"12px 24px",marginTop:8,color:"#04060D",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>{idx>=QS.length-1?"See Result":"Next"} &#8594;</button>:null}
          </div>
        )}
      </div>
    </div>
