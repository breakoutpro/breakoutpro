...
export default function StocksBuddy(){
  ...
  if(phase==="auth") return(
    <div style={{position:"relative",width:"100%",maxWidth:430,margin:"0 auto",minHeight:"100vh",background:"#F8F9FA",color:"#111827",fontFamily:"'Inter','Poppins','Segoe UI',sans-serif",overflowY:"auto"}}>
      <style>{CSS}</style>
