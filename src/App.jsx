...
export default function App() {
  ...
  var MORE_SCREENS = ["global","heatmap","fiidii","journal","challenges","sub","tools","candle","chart","detector","analysis","scalper","quiz","briefing","oi","alerts","settings","patterns","paper","share"];
  useEffect(function(){
    function onBack(e){
      e.preventDefault();
