...
export function SemicircleGauge(props){
  ...
  return (
    <div style={{position:"relative",width:180,height:118}}>
      <div style={{position:"relative",width:180,height:100,overflow:"hidden"}}>
        ...
        <div style={{position:"absolute",bottom:10,left:"50%",width:2,height:74,background:MT.T1,transformOrigin:"bottom center",transform:"translateX(-50%) rotate("+angle+"deg)"}}/>
        <div style={{position:"absolute",bottom:5,left:"50%",width:10,height:10,borderRadius:"50%",background:MT.T1,transform:"translateX(-50%)"}}/>
      ...
      <div style={{display:"flex",justifyContent:"space-between",width:180,fontSize:9,color:MT.T3,fontWeight:700,marginTop:6}}>
