...
export default function StrategyForm(props){
  ...
  return (
    <div style={{padding:14}}>
      ...
      <div style={{fontSize:15,fontWeight:800,color:T1,marginBottom:16}}>{editing?"Edit Strategy":"Create Strategy"}</div>
      ...
      <button onClick={submit} style={{width:"100%",background:BLUE,border:"none",borderRadius:11,padding:13,color:"#fff",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"inherit",marginTop:6,minHeight:44}}>{editing?"Save Changes":"Save Strategy"}</button>
    </div>
  );
}
