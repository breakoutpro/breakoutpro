...
function MoreScreen(props) {
  ...
  var sections = [
    {title:"Practice & Learning", items:[
      {id:"portfolio",  label:"AI Portfolio Review",  sub:"AI analyzes your holdings (educational)"},
...
function AppInner() {
  ...
  function renderScreen(){
    return (
      ...
      <Suspense fallback={<Loader/>}>
        ...
        {tab=="academy"   ? <AcademyHome onBack={function(){setTab("more");}}/> : null}
  ...
  var appColumn = (
    <div style={{position:"relative",width:"100%",maxWidth:centerW,margin:"0 auto",height:isDesktop?"100%":"100vh",overflow:"hidden",fontFamily:"Inter,Arial,sans-serif",background:theme.c.bg,filter:brightness!=100?"brightness("+(brightness/100)+")":"none"}}>
      <div style={{height:isDesktop?"100%":"100vh",overflowY:"auto",overflowX:"hidden"}}>
    ...
    <div style={{width:W,flexShrink:0,height:"calc(100vh - 48px)",position:"sticky",top:24,background:BG,border:"1px solid "+BD,borderRadius:20,padding:16,boxSizing:"border-box",display:"flex",flexDirection:"column"}}>
      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:24,padding:"4px 8px"}}>
        ...
        <div>
          ...
          <div style={{fontSize:12,color:theme.c.warn,fontWeight:800,letterSpacing:1.5}}>CATCH EVERY BREAKOUT</div>
        </div>
      </div>
      <div style={{flex:1}}>
        {items.map(function(it){
          ...
          return (
            <button key={it.id} onClick={function(){props.setTab(it.id);}} style={{width:"100%",background:act?"rgba(79,140,255,0.12)":"none",border:"1px solid "+(act?"rgba(79,140,255,0.3)":"transparent"),borderRadius:12,padding:"12px 16px",marginBottom:4,display:"flex",alignItems:"center",gap:12,cursor:"pointer",fontFamily:"inherit",textAlign:"left",transition:"all 0.18s"}}>
