      ...
      <div style={{background:CB, padding:"14px 14px", borderBottom:"1px solid "+BD}}>
        <div style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
          ...
          <div style={{display:"flex", gap:6}}>
            <button onClick={function(){setTab&&setTab("newsstudio");}} style={{background:"rgba(212,175,55,0.15)",border:"1px solid rgba(212,175,55,0.3)",borderRadius:20,padding:"5px 12px",color:"#D4AF37",fontSize:9,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>AI News Studio</button>
            {isAdmin?(
