          ...
          <div>
            {alerts.length==0?(
              ...
              alerts.map(function(al){
                ...
                var col=pc.col;
                return (
                  <div key={al.id} style={{background:CARD,border:"1px solid "+BD,borderRadius:14,padding:"12px 13px",marginBottom:8,borderLeft:"3px solid "+col}}>
                    <div style={{display:"flex",alignItems:"center",gap:10}}>
                      ...
                      <div style={{flex:1,minWidth:0}}>
                        ...
                        <div style={{fontSize:10,color:T2,fontWeight:600}}>{al.type}</div>
                        <div style={{fontSize:8.5,color:T3,marginTop:2}}>{pc.explain}</div>
                      </div>
                      <div style={{textAlign:"right",flexShrink:0}}>
                        <div style={{fontSize:8,color:T3}}>{al.time}</div>
                        <div style={{fontSize:9,fontWeight:800,color:al.conf>=80?UP:al.conf>=65?GOLD:DOWN,marginTop:3}}>{al.conf}%</div>
                      </div>
                    </div>
                  </div>
                );
