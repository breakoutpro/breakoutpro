        ...
        <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:14,padding:padV,marginBottom:gapV,display:wideLayout?"flex":"block",alignItems:"center",gap:28,flexWrap:"wrap"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:16,flexShrink:0}}>
            ...
            <div>
              ...
              {mm.lastUpdated ? <div style={{fontSize:11,color:MT.T3,marginTop:4}}>Last Updated: {new Date(mm.lastUpdated).toLocaleString("en-IN",{day:"numeric",month:"short",year:"numeric",hour:"numeric",minute:"2-digit"})}</div> : null}
            </div>
          </div>
