              ...
              return (
                <div>
                  <div style={{display:"flex",alignItems:"center",gap:20,marginBottom:12}}>
                    <Gauge mood={mood}/>
                    <div>
                      <div style={{fontSize:tierCfg.widgetTitle,fontWeight:900,color:mood.label.indexOf("Bullish")>=0?UP:(mood.label.indexOf("Bearish")>=0?DOWN:GOLD),marginBottom:4}}>{mood.label}</div>
                      ...
                      <div style={{fontSize:tierCfg.secondaryText,color:T2}}>Confidence: <span style={{color:T1,fontWeight:700}}>{mood.confidence}</span></div>
                    </div>
                  </div>
