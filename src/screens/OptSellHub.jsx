...
export default function OptSellHub(props){
  ...
  var BG = theme.c.bg, CARD = theme.c.card, CARD2 = theme.c.card2, BLUE=theme.c.blue, T2 = theme.c.text2, T3 = theme.c.text3; T1=theme.c.text1; UP=theme.c.up;
    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:90}}>
      ...
      <div style={{padding:16}}>
        {tab=="dash"?(
          <div>
            {/* expiry countdown */}
            <div style={{background:theme.c.card,border:"1px solid rgba(37,99,235,0.25)",borderRadius:16,padding:16,marginBottom:16,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div>
