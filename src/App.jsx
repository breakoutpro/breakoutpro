...
function HeatmapScreen() {
  ...
  function col(chg){if(chg>=3)return{bg:theme.c.brand,tx:"#fff"};if(chg>=1.5)return{bg:"#4CAF50",tx:"#fff"};if(chg>=0)return{bg:"#1A3A1A",tx:G2};if(chg>=-1.5)return{bg:"#3A1A1A",tx:R};return{bg:R,tx:"#fff"};}
  return (
    ...
    <div style={{position:"relative",width:"100%",maxWidth:centerW,margin:"0 auto",height:isDesktop?"100%":"100vh",overflow:"hidden",fontFamily:"Inter,Arial,sans-serif",background:"#F8F9FA",filter:brightness!=100?"brightness("+(brightness/100)+")":"none"}}>
      ...
      {!notifAsked && typeof Notification != "undefined" && Notification.permission == "default" ? (
        <div style={{position:"fixed",bottom:65,left:0,right:0,zIndex:998,padding:"0 14px",maxWidth:centerW,margin:"0 auto"}}>
          <div style={{background:"#0F1629",border:"1px solid rgba(0,200,83,0.3)",borderRadius:14,padding:"12px 16px",display:"flex",alignItems:"center",gap:12,boxShadow:"0 -4px 20px rgba(0,0,0,0.5)"}}>
            <div style={{fontSize:22}}>&#128276;</div>
            <div style={{flex:1}}>
              <div style={{fontSize:12,fontWeight:700,color:"#fff",marginBottom:4}}>Enable Alert Notifications</div>
              <div style={{fontSize:12,color:"#8899BB"}}>Get breakout & pattern alerts on your phone</div>
            </div>
...
function DesktopLeftSidebar(props){
  ...
  var BG=theme.c.bgAlt,BD="#1B2330",T1="#FFFFFF",T2="#8899BB",T3=theme.c.text3,BLUE="#4F8CFF";
  ...
  return (
    <div style={{width:W,flexShrink:0,height:"calc(100vh - 48px)",position:"sticky",top:24,background:BG,border:"1px solid "+BD,borderRadius:20,padding:16,boxSizing:"border-box",display:"flex",flexDirection:"column"}}>
      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:24,padding:"4px 8px"}}>
        <div style={{width:42,height:42,borderRadius:13,background:"#2563EB",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,fontWeight:900,color:"#fff"}}>B</div>
        <div>
      ...
      <div style={{borderTop:"1px solid "+BD,paddingTop:16}}>
        <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:12,padding:"0 6px"}}>
          <div style={{width:34,height:34,borderRadius:"50%",background:"#2563EB",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:900,color:"#fff"}}>{props.user.name[0].toUpperCase()}</div>
...
function DesktopRightSidebar(props){
  ...
  var BG=theme.c.bgAlt,BD="#1B2330",BD2=theme.c.border2,T1="#FFFFFF",T3=theme.c.text3,BLUE="#4F8CFF";
