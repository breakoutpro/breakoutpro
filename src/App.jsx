  ...
  return (
    <div style={{background:"#F8F9FA",minHeight:"100vh",display:"flex",flexDirection:"column"}}>
      <div style={{background:"#fff",padding:"32px 20px 24px",textAlign:"center",borderBottom:"1px solid #F0F0F0"}}>
        ...
        <div style={{fontSize:8,color:theme.c.warn,fontWeight:800,letterSpacing:2,marginTop:3}}>CATCH EVERY BREAKOUT</div>
      ...
      <div style={{padding:"24px 20px",flex:1}}>
        ...
        {err?<div style={{background:"#FEF2F2",border:"1px solid #FECACA",borderRadius:10,padding:"10px 12px",marginBottom:12,fontSize:11,color:theme.c.down}}>! {err}</div>:null}
        ...
        <button style={{width:"100%",background:theme.c.blue,border:"none",borderRadius:12,padding:"14px",fontSize:13,fontWeight:700,color:"#fff",cursor:"pointer",fontFamily:"inherit"}} onClick={submit}>
...
function GlobalScreen() {
  ...
  return (
    <div style={{background:DB,minHeight:"100%",paddingBottom:80,padding:14,fontFamily:"Inter,Arial,sans-serif"}}>
      <div style={{fontSize:18,fontWeight:900,color:T1,marginBottom:14}}>Global <span style={{color:theme.c.brand}}>Markets</span></div>
...
function HeatmapScreen() {
  ...
  return (
    <div style={{background:DB,minHeight:"100%",paddingBottom:80,fontFamily:"Inter,Arial,sans-serif"}}>
      <div style={{padding:"14px 14px 8px",fontSize:16,fontWeight:900,color:T1}}>NIFTY 50 <span style={{color:theme.c.brand}}>Heatmap</span></div>
...
function FiiScreen() {
  ...
  return (
    <div style={{background:DB,minHeight:"100%",paddingBottom:80,padding:14,fontFamily:"Inter,Arial,sans-serif"}}>
      <div style={{fontSize:18,fontWeight:900,color:T1,marginBottom:14}}>FII / <span style={{color:theme.c.brand}}>DII</span></div>
...
function MoreScreen(props) {
  ...
  return (
    <div style={{background:BG,minHeight:"100vh",paddingBottom:80,fontFamily:"Inter,Arial,sans-serif"}}>
      <div style={{background:BG,padding:"20px 16px 14px",borderBottom:"1px solid "+BORDER}}>
            ...
            <div key={sec.title} style={{marginBottom:18}}>
              ...
              <div style={{background:CARD,border:"1px solid "+BORDER,borderRadius:16,overflow:"hidden"}}>
                {sec.items.map(function(item,i){
                  ...
                  return (
                    <div key={item.id} onClick={function(){props.setTab(item.id);}} style={{display:"flex",alignItems:"center",gap:12,padding:"14px 14px",borderBottom:i<sec.items.length-1?"1px solid "+BORDER2:"none",cursor:"pointer"}}>
                      ...
                      <div style={{flex:1}}>
                        <div style={{fontSize:13,fontWeight:700,color:isAction?BLUE:T1}}>{item.label}</div>
    ...
    <div style={{position:"relative",width:"100%",maxWidth:centerW,margin:"0 auto",height:isDesktop?"100%":"100vh",overflow:"hidden",fontFamily:"Inter,Arial,sans-serif",background:"#F8F9FA",filter:brightness!=100?"brightness("+(brightness/100)+")":"none"}}>
      ...
      {!notifAsked && typeof Notification != "undefined" && Notification.permission == "default" ? (
        <div style={{position:"fixed",bottom:65,left:0,right:0,zIndex:998,padding:"0 14px",maxWidth:centerW,margin:"0 auto"}}>
          <div style={{background:"#0F1629",border:"1px solid rgba(0,200,83,0.3)",borderRadius:14,padding:"12px 14px",display:"flex",alignItems:"center",gap:10,boxShadow:"0 -4px 20px rgba(0,0,0,0.5)"}}>
            ...
            }} style={{background:theme.c.brand,border:"none",borderRadius:10,padding:"8px 14px",color:"#fff",fontSize:10,fontWeight:700,cursor:"pointer",fontFamily:"inherit",flexShrink:0}}>Enable</button>
        ...
        <div style={{position:"absolute",top:0,left:0,right:0,bottom:0,zIndex:200,display:"flex"}}>
          <div style={{width:260,background:"#fff",borderRight:"1px solid #E5E7EB",display:"flex",flexDirection:"column",boxShadow:"4px 0 24px rgba(0,0,0,0.1)"}}>
            ...
            <div style={{padding:"16px",borderTop:"1px solid #F0F0F0"}}>
              ...
              <button style={{width:"100%",background:"#FEF2F2",border:"1px solid #FECACA",borderRadius:10,padding:"11px",color:theme.c.down,fontSize:12,fontWeight:600,cursor:"pointer",fontFamily:"inherit"}} onClick={logout}>Logout</button>
            </div>
          </div>
    ...
    <div style={{width:W,flexShrink:0,height:"calc(100vh - 48px)",position:"sticky",top:24,background:BG,border:"1px solid "+BD,borderRadius:20,padding:18,boxSizing:"border-box",display:"flex",flexDirection:"column"}}>
      <div style={{display:"flex",alignItems:"center",gap:11,marginBottom:24,padding:"4px 6px"}}>
        ...
        <div>
          ...
          <div style={{fontSize:7,color:theme.c.warn,fontWeight:800,letterSpacing:1.5}}>CATCH EVERY BREAKOUT</div>
        </div>
      </div>
      <div style={{flex:1}}>
