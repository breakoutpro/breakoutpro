...
export default function OptSellHubDetail(props){
  ...
  var BD2 = theme.c.border2, BG = theme.c.bg, CARD = theme.c.card, CARD2 = theme.c.card2, T2 = theme.c.text2;
          ...
          <Sec t="RELATED TOPICS">
            <div style={{display:"flex",gap:7,flexWrap:"wrap"}}>
              {d.related.map(function(r,i){
                return <span key={i} style={{fontSize:10,color:CYAN,background:"rgba(59,130,246,0.1)",border:"1px solid rgba(59,130,246,0.25)",borderRadius:14,padding:"6px 12px"}}>{r}</span>;
              })}
            </div>
          </Sec>
        ):null}
