  ...
  return (
    <div style={{background:BG,minHeight:"100vh",width:"100%",boxSizing:"border-box",overflowX:"hidden",fontFamily:"'Inter',Arial,sans-serif",paddingBottom:84,color:T1}}>
      ...
      <div style={{width:"100%",boxSizing:"border-box",padding:"7px 9px 0"}}>
        ...
        <Card title="Options Intelligence" icon="&#128202;" onDetails={function(){ if(props.setShowOptions) props.setShowOptions(true); else setTab("optionsintelpro"); }}>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:5,marginBottom:6}}>
            <div><div style={{fontSize:9,color:T3}}>PCR</div><div style={{fontSize:11,fontWeight:700,color:T2}}>&#8212;</div></div>
            <div><div style={{fontSize:9,color:T3}}>Max Pain</div><div style={{fontSize:11,fontWeight:700,color:T2}}>&#8212;</div></div>
            <div><div style={{fontSize:9,color:T3}}>Call OI</div><div style={{fontSize:11,fontWeight:700,color:T2}}>&#8212;</div></div>
            <div><div style={{fontSize:9,color:T3}}>Put OI</div><div style={{fontSize:11,fontWeight:700,color:T2}}>&#8212;</div></div>
            <div><div style={{fontSize:9,color:T3}}>IV</div><div style={{fontSize:11,fontWeight:700,color:T2}}>&#8212;</div></div>
            <div><div style={{fontSize:9,color:T3}}>Greeks</div><div style={{fontSize:11,fontWeight:700,color:T2}}>&#8212;</div></div>
          </div>
          <div style={{fontSize:11,color:T3}}>Connect a verified options-chain provider to activate live data.</div>
        </Card>
