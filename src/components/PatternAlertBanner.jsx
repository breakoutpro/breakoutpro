...
export default function PatternAlertBanner(props){
  ...
  return (
    <div style={{position:"fixed",top:visible?12:-120,left:12,right:12,zIndex:3000,transition:"top 0.35s ease",fontFamily:"Inter,Arial,sans-serif"}}>
      <div onClick={onView} style={{background:""+CARD+"",border:"1px solid "+col+"50",borderLeft:"4px solid "+col,borderRadius:14,padding:"12px 14px",boxShadow:"0 8px 24px rgba(0,0,0,0.4)",cursor:"pointer",display:"flex",alignItems:"center",gap:10}}>
