  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      <div style={{background:CB,padding:"12px 14px",borderBottom:"1px solid "+BD}}>
        <div style={{fontSize:16,fontWeight:900,color:T1}}>Trading <span style={{color:BLUE}}>Tools</span></div>
        <div style={{display:"flex",gap:6,marginTop:10}}>
          {[["rr","R:R Calc"],["pos","Position Size"],["brok","Brokerage"]].map(function(t){
            var act=tool==t[0];
            return <button key={t[0]} style={{background:act?BLUE:"rgba(255,255,255,0.06)",border:"1px solid "+(act?BLUE:BD),borderRadius:20,padding:"6px 14px",color:act?"#fff":T2,fontSize:9,fontWeight:act?700:500,cursor:"pointer",fontFamily:"inherit"}} onClick={function(){setTool(t[0]);}}>{t[1]}</button>;
          })}
        </div>
      </div>
      <div style={{padding:14}}>
        ...
        <div style={{background:"rgba(249,115,22,0.08)",border:"1px solid rgba(249,115,22,0.2)",borderRadius:10,padding:10,marginTop:14}}>
          <div style={{fontSize:8,color:theme.c.warn}}>Educational only. Not SEBI registered. Not investment advice.</div>
        </div>
      </div>
    </div>
  );
  ...
  if(show) return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:14}}>
        ...
        <button onClick={add} style={{width:"100%",background:BLUE,border:"none",borderRadius:12,padding:14,color:"#fff",fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Save Trade</button>
      </div>
    </div>
  );
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80,padding:14}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        ...
        <button onClick={function(){setShow(true);}} style={{background:BLUE,border:"none",borderRadius:10,padding:"8px 14px",color:"#fff",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>+ Add</button>
      </div>
      ...
      {entries.length>0&&(
        <div style={{marginBottom:14}}>
          {aiInsight&&(
            <div style={{background:theme.c.card,border:"1px solid rgba(124,58,237,0.25)",borderRadius:14,padding:"14px",marginBottom:10}}>
          ...
          <button onClick={getAIInsight} disabled={aiLoading} style={{width:"100%",background:aiLoading?"rgba(124,58,237,0.3)":"#2563EB",border:"none",borderRadius:12,padding:"11px",color:"#fff",fontSize:11,fontWeight:700,cursor:aiLoading?"not-allowed":"pointer",fontFamily:"inherit"}}>
...
export function ChallengesScreen() {
  ...
  if(active) return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80,padding:14}}>
      ...
      <div style={{background:CB,border:"1px solid "+BD,borderRadius:16,padding:20}}>
        <div style={{fontSize:11,color:BLUE,fontWeight:700,marginBottom:8}}>{active.title} - +{active.xp} XP</div>
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80,padding:14}}>
      <div style={{background:"#0F1629",border:"1px solid rgba(0,200,83,0.2)",borderRadius:16,padding:16,marginBottom:14,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
