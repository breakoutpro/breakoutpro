...
import { loadObservation, saveObservation, ASSET_SUGGEST, NIFTY50, BANKNIFTY, POPULAR_INDICES, POPULAR_OPTIONS, parseOptionContract, addBasket, getAssetCard, DEMO_WATCHLIST } from "./GuardianData";
...
// Compact full-width observation card (~90px).
function ObsCard(props){
  ...
  return (
    <div onClick={props.onOpen} style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:"11px 12px",marginBottom:8,cursor:"pointer",display:"flex",alignItems:"center",gap:11}}>
      {/* logo */}
