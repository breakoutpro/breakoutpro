  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:40}}>
      ...
      <div style={{padding:14}}>
        ...
        {/* deeper module link */}
        {d.deeper?(
          <button onClick={function(){setTab(d.deeper);}} style={{width:"100%",background:"rgba(59,130,246,0.12)",border:"1px solid rgba(59,130,246,0.3)",borderRadius:11,padding:"13px",marginBottom:14,color:BLUE,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Explore the full module &#8594;</button>
        ):null}
