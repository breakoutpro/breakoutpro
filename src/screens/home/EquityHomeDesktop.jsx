      ...
      <div style={{flex:1,display:"flex",minHeight:0,maxWidth:1900,margin:"0 auto",width:"100%"}}>
        ...
        {railCollapsed ? (
          ...
          <div style={{width:railWidth,flexShrink:0,borderLeft:"1px solid "+BD,background:CARD,display:"flex",flexDirection:"column",minHeight:0}}>
            ...
            {/* Watchlist - fixed, always visible, never collapsible */}
            <div style={{borderBottom:"1px solid "+BD2,flexShrink:0,maxHeight:180,display:"flex",flexDirection:"column"}}>
              <div style={{padding:"6px 12px",fontSize:11,fontWeight:800,color:T1,flexShrink:0}}>Watchlist</div>
              <div style={{padding:"0 12px 8px",overflowY:"auto"}}>{renderRailBody("watchlist")}</div>
            </div>
