      ...
      <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:32}}>
        ...
        <div style={{padding:16}}>
          ...
          <div style={{textAlign:"center",marginBottom:16}}>
            <span style={{background:(selected.type=="bullish"?"rgba(0,200,83,0.1)":selected.type=="bearish"?"rgba(239,68,68,0.1)":"rgba(37,99,235,0.1)"),borderRadius:20,padding:"4px 16px",fontSize:12,fontWeight:700,color:badgeCol,textTransform:"capitalize"}}>{selected.type} Signal</span>
          </div>
          {det?[
