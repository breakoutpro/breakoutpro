          ...
          <div>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
              {SYMBOLS.map(function(s){
                var act=symbol==s;
                return <button key={s} onClick={function(){setSymbol(s);setResult(null);}} style={{background:act?"rgba(37,99,235,0.2)":"rgba(255,255,255,0.04)",border:"1px solid "+(act?BLUE:BD),borderRadius:6,padding:"4px 8px",color:act?BLUE:T2,fontSize:12,fontWeight:act?700:400,cursor:"pointer",fontFamily:"inherit"}}>{s}</button>;
              })}
            </div>
          </div>
          <div>
        ...
        {result&&(
          <div>
            <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
              <span style={{fontSize:12,fontWeight:800,color:BLUE,background:"rgba(37,99,235,0.12)",border:"1px solid rgba(37,99,235,0.3)",padding:"4px 8px",borderRadius:5,letterSpacing:0.5}}>SIMULATED DATA</span>
