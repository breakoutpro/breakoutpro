  ...
  return (
    <div style={{display:"flex",alignItems:"center",gap:12,padding:"12px 16px",borderBottom:"1px solid "+BD}}>
      ...
      <div style={{flex:1}}>
        ...
        <div style={{fontSize:12,color:T2,marginTop:4}}>{props.sub}</div>
      </div>
...
var TYPES=[
  ...
  {key:"patternAlert",  icon:"&#128208;", label:"Pattern Alerts",  sub:"Doji, Hammer, Engulfing etc",   bg:"rgba(37,99,235,0.1)",bd:"rgba(37,99,235,0.2)"},
