  ...
  return (
    <div>
      ...
      <div style={{display:"flex",alignItems:"center",gap:8,marginTop:10}}>
        ...
        {[1,2].map(function(sp){
          var act=speed==sp;
          return <button key={sp} onClick={function(){setSpeed(sp);}} style={{background:act?BLUE:"rgba(255,255,255,0.05)",border:"1px solid "+(act?BLUE:GRID),borderRadius:8,padding:"6px 11px",color:act?"#04060D":T2,fontSize:11,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>{sp}x</button>;
        })}
      </div>
