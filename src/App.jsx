...
export default function StocksBuddy(){
  ...
  return(
    ...
    {phase==="app"&&!chatOpen&&(
      <button onClick={function(){setChatOpen(true);}} style={{position:"fixed",bottom:82,right:14,width:52,height:52,borderRadius:"50%",background:"linear-gradient(135deg,#4285f4,#0d47a1)",border:"2px solid #4285f444",boxShadow:"0 4px 20px rgba(66,133,244,0.5)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",zIndex:150,fontSize:22}}>
        &#129302;
        {chatMsgs.length>0&&<span style={{position:"absolute",top:-3,right:-3,background:"#39FF14",borderRadius:"50%",width:14,height:14,fontSize:7,fontWeight:800,color:"#000",display:"flex",alignItems:"center",justifyContent:"center"}}>{chatMsgs.filter(function(m){return m.role==="ai";}).length}</span>}
      </button>
    )}
    ...
    {phase==="app"&&chatOpen&&(
      <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:250,display:"flex",flexDirection:"column",background:"#050505",maxWidth:430,margin:"0 auto"}}>
        ...
        <div style={{background:"linear-gradient(135deg,#0a0a2a,#050520)",borderBottom:"1px solid #1a1a3a",padding:"12px 14px",display:"flex",alignItems:"center",gap:10,flexShrink:0}}>
          <div style={{width:38,height:38,borderRadius:"50%",background:"linear-gradient(135deg,#4285f4,#0d47a1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}}>&#129302;</div>
          <div style={{flex:1}}>
