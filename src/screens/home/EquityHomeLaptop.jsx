...
export default function EquityHomeLaptop(props){
  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",color:T1,overflowX:"hidden",display:"flex",flexDirection:"column"}}>
      ...
      {/* MARKET BREADTH / FII-DII FLOW / LATEST ALERTS - no real provider
          exists anywhere in this codebase for any of these three, so no
          numbers are shown. The feature structure itself is shown (matching
          the same principle already used for the Options Intelligence card)
          so users understand what Breakout Pro provides, without fabricating
          any value. */}
      <div style={{padding:"0 20px 16px",display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:tierCfg.gridGap}}>
