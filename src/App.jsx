  ...
  return (
    <div style={{background:"#F8F9FA",minHeight:"100vh",display:"flex",flexDirection:"column"}}>
      <div style={{background:"#fff",padding:"32px 20px 24px",textAlign:"center",borderBottom:"1px solid #F0F0F0"}}>
        <div style={{width:56,height:56,borderRadius:16,background:"linear-gradient(135deg,#2563EB,#1D4ED8)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 12px",boxShadow:"0 4px 14px rgba(37,99,235,0.3)"}}>
...
function MoreScreen(props) {
  ...
  var sections = [
    ...
    {title:"Tools & Calculators", col:BLUE, items:[
      ...
      {id:"tools",    label:"Risk Calculator",      sub:"R:R ratio, position size, Greeks",    col:theme.c.warn},
    ]},
    {title:"Account & Settings", col:GOLD, items:[
      ...
      {id:"marketclose",label:"Market Close Summary",sub:"Today's recap and tomorrow's watch", col:"#7C3AED"},
      {id:"news",       label:"Market News",        sub:"Live news feed from ET Markets",     col:"#60A5FA"},
      {id:"ipo",        label:"IPO Center Pro",       sub:"Educational/Demo IPO Center - details, timeline, education",    col:GOLD     },
      ...
      {id:"newsstudio", label:"AI News Studio",       sub:"Real headlines, AI sentiment, shareable cards", col:theme.c.blue},
      {id:"academy",    label:"Trading Academy",       sub:"Structured lessons, quizzes, real progress tracking", col:"#22C55E"},
      {id:"aimentor",   label:"AI Mentor",              sub:"Ask trading questions, offline rule-based answers", col:theme.c.blue},
      {id:"optionsintelpro", label:"Options Intelligence Pro", sub:"Greeks, Max Pain, PCR, IV Crush - fully offline", col:"#06B6D4"},
      {id:"stockresearchpro", label:"AI Stock Research Pro", sub:"Real technical analysis, honest data-availability", col:theme.c.blue},
      {id:"marketreplay", label:"Market Replay Simulator", sub:"Replay real historical candles, mark your decisions", col:theme.c.gold},
      {id:"econcalendar", label:"Economic Calendar Pro", sub:"Educational/Demo Calendar - RBI, Fed, CPI, earnings & more", col:theme.c.gold},
      {id:"fiidiipro", label:"FII / DII Intelligence Pro", sub:"Educational/Demo Data - flow trends, buy vs sell", col:theme.c.gold},
      {id:"marketheatmap", label:"Market Heatmap Pro", sub:"Real sector data where available, demo elsewhere", col:"#22C55E"},
      {id:"dividendtracker", label:"Dividend Tracker Pro", sub:"Educational/Demo Dividend Tracker - dates, yield & more", col:theme.c.gold},
      {id:"globalmarketspro", label:"Global Markets Dashboard Pro", sub:"Real data where available, demo elsewhere", col:theme.c.blue},
      {id:"alertcenterpro", label:"Alert Center Pro", sub:"Manage your own alert rules, saved locally", col:theme.c.blue},
          ...
          <div style={{width:260,background:"#fff",borderRight:"1px solid #E5E7EB",display:"flex",flexDirection:"column",boxShadow:"4px 0 24px rgba(0,0,0,0.1)"}}>
            <div style={{padding:"20px 16px",borderBottom:"1px solid #F0F0F0"}}>
              <div style={{display:"flex",alignItems:"center",gap:10}}>
                <div style={{width:40,height:40,borderRadius:"50%",background:"linear-gradient(135deg,#2563EB,#1D4ED8)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:900,color:"#fff"}}>{user.name[0].toUpperCase()}</div>
                <div>
  ...
  return (
    <div style={{width:W,flexShrink:0,height:"calc(100vh - 48px)",position:"sticky",top:24,background:BG,border:"1px solid "+BD,borderRadius:20,padding:18,boxSizing:"border-box",display:"flex",flexDirection:"column"}}>
      <div style={{display:"flex",alignItems:"center",gap:11,marginBottom:24,padding:"4px 6px"}}>
        <div style={{width:42,height:42,borderRadius:13,background:"linear-gradient(135deg,#2563EB,#1D4ED8)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,fontWeight:900,color:"#fff"}}>B</div>
        <div>
      ...
      <div style={{borderTop:"1px solid "+BD,paddingTop:14}}>
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:12,padding:"0 6px"}}>
          <div style={{width:34,height:34,borderRadius:"50%",background:"linear-gradient(135deg,#2563EB,#1D4ED8)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,fontWeight:900,color:"#fff"}}>{props.user.name[0].toUpperCase()}</div>
