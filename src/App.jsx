...
export default function StocksBuddy(){
  ...
  return(
    <div style={{position:"relative",width:"100%",maxWidth:430,margin:"0 auto",height:"100vh",background:"#0B0B0B",color:"#fff",fontFamily:"Inter,Poppins,Segoe UI,sans-serif",overflow:"hidden",display:"flex",flexDirection:"column"}}>
      {phase==="splash"&&(
        <div style={{position:"absolute",top:0,left:0,right:0,bottom:0,background:"radial-gradient(ellipse at center,#0d1f0d 0%,#000 70%)",display:"flex",alignItems:"center",justifyContent:"center",padding:20,zIndex:10}}>
        ...
        {splashS===3&&<div style={{position:"relative",width:100,height:100,margin:"20px auto 0"}}><svg width="100" height="100" style={{transform:"rotate(-90deg)"}}><circle cx="50" cy="50" r="40" fill="none" stroke="#1a2a1a" strokeWidth="7"/><circle cx="50" cy="50" r="40" fill="none" stroke="#22C55E" strokeWidth="7" strokeDasharray="251.33 0" strokeLinecap="round"/></svg><div style={{position:"absolute",top:0,left:0,right:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"monospace",fontSize:19,fontWeight:900,color:"#22C55E"}}>100%</div></div>}
          </div>
        </div>
      )}
      {phase==="auth"&&(
