...
export default function ChartScreen() {
  ...
  var indicators = [
    ...
    {label:"EMA 21",val: (ema21.length? (ema21[ema21.length-1]==null?"--":ema21[ema21.length-1]) : "--"), color:"#3B82F6", sub: (ema21.length && ema21[ema21.length-1]!=null) ? (lastC.close > ema21[ema21.length-1] ? "Bullish" : "Bearish") : "Insufficient data"},
    ...
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{background:CB,padding:"12px 14px",borderBottom:"1px solid "+BD}}>
        ...
        <div style={{display:"flex",gap:6}}>
          ...
          <button onClick={load} style={{background:"rgba(0,200,83,0.1)",border:"1px solid rgba(0,200,83,0.3)",borderRadius:8,padding:"4px 10px",color:G,fontSize:9,cursor:"pointer",fontFamily:"inherit"}}>Refresh</button>
        </div>
      </div>
      ...
      <div style={{padding:14}}>
        ...
        <div style={{background:"rgba(249,115,22,0.08)",border:"1px solid rgba(249,115,22,0.2)",borderRadius:10,padding:10}}>
          <div style={{fontSize:8,color:"#F97316"}}>
