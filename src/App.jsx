        ...
        {tab==="home"&&(
          <div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,margin:"0 12px 10px 12px"}}>
              <div style={{background:"linear-gradient(135deg,#0a1a0a,#001500)",border:"1px solid "+(nifty.chg>=0?"#39FF1444":"#ff444444"),borderRadius:13,padding:"12px"}}>
              ...
              <div style={{background:"linear-gradient(135deg,#0a1a0a,#001500)",border:"1px solid "+(sensex.chg>=0?"#39FF1444":"#ff444444"),borderRadius:13,padding:"12px"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
