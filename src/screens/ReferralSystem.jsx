  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:"16px"}}>
        ...
        {/* Hero Card */}
        <div style={{background:theme.c.card,border:"1px solid rgba(245,158,11,0.3)",borderRadius:16,padding:"16px",marginBottom:16,textAlign:"center"}}>
        ...
        <div style={{background:CB,border:"1px solid "+BD,borderRadius:16,padding:"16px",marginBottom:16}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,background:"rgba(245,158,11,0.08)",border:"1px dashed "+BLUE,borderRadius:12,padding:"12px 16px",marginBottom:12}}>
            <span style={{fontSize:18,fontWeight:900,color:BLUE,fontFamily:"monospace",letterSpacing:2,flex:1}}>{data.code}</span>
            <button onClick={copyCode} style={{background:copied?"rgba(34,197,94,0.2)":"rgba(245,158,11,0.2)",border:"1px solid "+(copied?UP:BLUE),borderRadius:8,padding:"8px 12px",color:copied?UP:BLUE,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit",flexShrink:0}}>
