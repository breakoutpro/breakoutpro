...
var TICKER_TEXT="FII Net Buyers \u20B93,245 Cr \u2022 Nifty Resistance 24,050 \u2022 BankNifty Bullish \u2022 India VIX 13.4 \u2022";
...
export default function EquityHome(props){
  ...
  useEffect(function(){
    ...
    var tk=setInterval(function(){setTickerX(function(x){return x-1;});},30);
  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",paddingBottom:84,color:T1}}>
      ...
      {/* HEADER */}
      <div style={{background:BG,borderBottom:"1px solid "+BD,padding:"13px 16px"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <button onClick={function(){setTab("more");}} style={{background:"none",border:"none",padding:4,cursor:"pointer"}}>
          ...
          <div style={{textAlign:"center"}}>
            ...
            <div style={{fontSize:7.5,color:T3,fontWeight:700,letterSpacing:1.5,marginTop:1}}>CATCH EVERY BREAKOUT</div>
          </div>
          <div style={{display:"flex",gap:12,alignItems:"center"}}>
            <button onClick={function(){setTab("alerts");}} style={{background:"none",border:"none",padding:4,cursor:"pointer",position:"relative"}}>
              <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke={T1} strokeWidth="2" strokeLinecap="round">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>
              </svg>
              <div style={{position:"absolute",top:2,right:2,width:6,height:6,borderRadius:"50%",background:GOLD,border:"1.5px solid "+BG}}/>
            </button>
      ...
      {/* LIVE TICKER */}
      <div style={{background:"#0A0D12",borderBottom:"1px solid "+BD,padding:"6px 0",display:"flex",alignItems:"center",gap:0,overflow:"hidden"}}>
        <div style={{background:"#EF4444",borderRadius:"0 4px 4px 0",padding:"2px 8px",marginRight:8,flexShrink:0}}>
          <span style={{fontSize:8.5,fontWeight:800,color:T1,letterSpacing:0.5}}>LIVE</span>
        </div>
        <div style={{overflow:"hidden",flex:1}}>
          <div style={{whiteSpace:"nowrap",transform:"translateX("+tickerX+"px)",transition:"none"}}>
            <span style={{fontSize:10,color:T2,fontWeight:500}}>{TICKER_TEXT}{TICKER_TEXT}</span>
          </div>
        </div>
      </div>
