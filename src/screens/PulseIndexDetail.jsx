...
export default function PulseIndexDetail(props){
  ...
  T1=theme.c.text1; DB=theme.c.bg; CB=theme.c.card; BD=theme.c.border; G2=theme.c.up; R=theme.c.down; GOLD=theme.c.gold; BLUE=theme.c.blue; T2=theme.c.text2; T3=theme.c.text3;
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:40,color:T1}}>
      ...
      {/* HEADER */}
      <div style={{background:DB,padding:"14px 16px",borderBottom:"1px solid "+BD,position:"sticky",top:0,zIndex:10}}>
      ...
      <div style={{padding:"14px 16px 0"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:16}}>
          <div style={{background:"rgba(220,38,38,0.08)",border:"1px solid "+R,borderRadius:12,padding:"12px 14px"}}>
            <div style={{fontSize:8,color:R,marginBottom:5}}>Resistance</div>
            <div style={{fontSize:15,fontWeight:800,color:R,fontFamily:"monospace"}}>{idx.res}</div>
          </div>
          <div style={{background:"rgba(0,143,57,0.08)",border:"1px solid "+G2,borderRadius:12,padding:"12px 14px"}}>
            <div style={{fontSize:8,color:G2,marginBottom:5}}>Support</div>
            <div style={{fontSize:15,fontWeight:800,color:G2,fontFamily:"monospace"}}>{idx.sup}</div>
          </div>
        </div>
        ...
        <div style={{background:CB,border:"1px solid rgba(37,99,235,0.15)",borderRadius:16,padding:16,marginBottom:16}}>
          ...
          <div style={{fontSize:11.5,color:T2,lineHeight:1.75}}>{idx.note}</div>
        </div>
