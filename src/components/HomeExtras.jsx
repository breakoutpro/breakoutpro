...
export function StreakBadge(props){
  var streak=props.streak||0;
  var onClick=props.onClick||function(){};
  if(streak<1)return null;
  return (
    <div onClick={onClick} style={{display:"inline-flex",alignItems:"center",gap:5,background:"rgba(245,158,11,0.1)",border:"1px solid rgba(245,158,11,0.3)",borderRadius:20,padding:"5px 11px",cursor:"pointer"}}>
      <span style={{fontSize:11}}>&#128293;</span>
      <span style={{fontSize:10,fontWeight:800,color:"#F59E0B"}}>{streak} day{streak>1?"s":""}</span>
    </div>
  );
}

export function StreakToast(props){
  var streak=props.streak||0;
  if(streak<2)return null;
  return (
    <div style={{background:"linear-gradient(135deg,rgba(245,158,11,0.15),rgba(124,58,237,0.08))",border:"1px solid rgba(245,158,11,0.3)",borderRadius:16,padding:"12px 14px",marginBottom:14,display:"flex",alignItems:"center",gap:10}}>
      <span style={{fontSize:20}}>&#128293;</span>
      <div>
        <div style={{fontSize:11.5,fontWeight:800,color:"#F59E0B"}}>{streak} day streak!</div>
        <div style={{fontSize:9,color:T3}}>You're building a great habit. Keep it up.</div>
      </div>
    </div>
  );
}
...
export var QUICK_ACTIONS=[
  {label:"Gainers", id:"gainers", col:UP,  icon:"<svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><polyline points='23 6 13.5 15.5 8.5 10.5 1 18'/><polyline points='17 6 23 6 23 12'/></svg>"},
  {label:"Losers",  id:"losers",  col:DOWN, icon:"<svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><polyline points='23 18 13.5 8.5 8.5 13.5 1 6'/><polyline points='17 18 23 18 23 12'/></svg>"},
  {label:"Sectors", id:"markets", col:CYAN, icon:"<svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='3' y='3' width='7' height='7' rx='1.5'/><rect x='14' y='3' width='7' height='7' rx='1.5'/><rect x='3' y='14' width='7' height='7' rx='1.5'/><rect x='14' y='14' width='7' height='7' rx='1.5'/></svg>"},
  {label:"Global",  id:"global",  col:CYAN, icon:"<svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><circle cx='12' cy='12' r='9'/><line x1='3' y1='12' x2='21' y2='12'/><path d='M12 3a14 14 0 0 1 0 18a14 14 0 0 1 0-18z'/></svg>"},
  {label:"Heatmap", id:"heatmap", col:"#A78BFA", icon:"<svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><rect x='3' y='3' width='8' height='8' rx='1.5'/><rect x='13' y='3' width='8' height='5' rx='1.5'/><rect x='13' y='10' width='8' height='11' rx='1.5'/><rect x='3' y='13' width='8' height='8' rx='1.5'/></svg>"},
];
