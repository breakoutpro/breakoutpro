  ...
  if(finished){
    return (
      <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",padding:"40px 20px",textAlign:"center"}}>
        ...
        <button onClick={restart} style={{background:"linear-gradient(135deg,"+BLUE+","+PURPLE+")",border:"none",borderRadius:12,padding:"12px 24px",color:"#fff",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Play Again</button>
      </div>
    );
  }
    ...
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:30}}>
      <div style={{background:CB,padding:"12px 16px",borderBottom:"1px solid "+BD}}>
        ...
        <div style={{height:5,background:"rgba(255,255,255,0.06)",borderRadius:3,overflow:"hidden"}}>
          <div style={{height:"100%",width:((qIdx+1)/QUESTIONS.length*100)+"%",background:"linear-gradient(90deg,"+BLUE+","+PURPLE+")"}}></div>
        </div>
      ...
      <div style={{padding:"16px 16px"}}>
        ...
        {showResult?(
          <button onClick={next} style={{width:"100%",background:"linear-gradient(135deg,"+BLUE+","+PURPLE+")",border:"none",borderRadius:12,padding:"13px",color:"#fff",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit",marginTop:6}}>{qIdx<QUESTIONS.length-1?"Next Question":"Finish Quiz"}</button>
        ):null}
      </div>
    </div>
  );
