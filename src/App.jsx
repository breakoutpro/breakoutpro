...
export default function App() {
  ...
  var MORE_SCREENS = ["global","heatmap","fiidii","journal","challenges","sub","tools","candle","chart","detector","analysis","scalper","quiz","briefing","oi","alerts"];
  useEffect(function(){
    function onBack(e){
      e.preventDefault();
  ...
  return (
    <div style={{position:"relative",width:"100%",maxWidth:430,margin:"0 auto",height:"100vh",overflow:"hidden",fontFamily:"Inter,Arial,sans-serif",background:"#F8F9FA"}}>
      ...
      {typeof window != "undefined" && "Notification" in window && window.Notification.permission == "default" && !notifAsked ? (
