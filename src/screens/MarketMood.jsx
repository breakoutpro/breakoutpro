  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{background:MT.CARD,borderBottom:"1px solid "+MT.BD,position:"sticky",top:0,zIndex:5}}>
        <div style={{display:"flex",alignItems:"center",gap:10,padding:wideLayout?"4px 10px":"6px 12px",maxWidth:1440,margin:"0 auto",boxSizing:"border-box"}}>
      ...
      <div style={{padding:wideLayout?"4px 8px":"10px 12px 16px",maxWidth:1440,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 3fr":undefined,gap:gapV,marginBottom:gapV,alignItems:"start"}}>
          ...
          {(function(){
            ...
            if(!anyReal){
              ...
              // look unfinished.
              return (
                <div style={{background:MT.CARD2,border:"1px solid "+MT.BD,borderRadius:8,padding:padV,boxSizing:"border-box"}}>
                  <div style={{fontSize:10,fontWeight:800,color:MT.T2,marginBottom:2}}>MARKET INTELLIGENCE</div>
                  <div style={{fontSize:11,color:MT.T2}}>AI commentary loading. Deterministic score above is already live.</div>
                </div>
              );
            }
        ...
        <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:8,padding:padV,marginBottom:gapV}}>
          ...
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"repeat(5, 1fr)":"repeat(2, minmax(0, 1fr))",gap:wideLayout?6:6}}>
