  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:16}}>
        ...
        <div style={{background:"rgba(37,99,235,0.06)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:12,padding:12,marginBottom:12}}>
        ...
        <button onClick={function(){setShowQuiz(!showQuiz);setQuizSel(null);setQuizQ(0);}} style={{width:"100%",background:"rgba(37,99,235,0.1)",border:"1px solid rgba(37,99,235,0.3)",borderRadius:12,padding:12,color:BLUE,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit",marginBottom:showQuiz?8:0}}>
