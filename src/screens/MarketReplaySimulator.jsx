  ...
  if(view=="summary"){
    ...
    return (
      <div style={{padding:14}}>
        ...
        <textarea value={notes} onChange={function(ev2){setNotes(ev2.target.value);}} style={{width:"100%",background:theme.c.card2,border:"1px solid "+BD,borderRadius:10,padding:"11px 12px",color:T1,fontSize:14,fontFamily:"inherit",minHeight:70,boxSizing:"border-box",marginBottom:14}}/>
