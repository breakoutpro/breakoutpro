...
function AppInner() {
  ...
  var appColumn = (
    <div style={{position:"relative",width:"100%",maxWidth:centerW,margin:"0 auto",height:isDesktop?"100%":"100vh",overflow:"hidden",fontFamily:"Inter,Arial,sans-serif",background:theme.c.bg,filter:brightness!=100?"brightness("+(brightness/100)+")":"none",display:"flex",flexDirection:"column"}}>
  ...
  return (
    <div style={{width:"100%",minHeight:"100vh",background:theme.c.bg,display:"flex",justifyContent:"center",fontFamily:"Inter,Arial,sans-serif"}}>
      <div style={{width:"100%",maxWidth:shellMax,display:"flex",gap:shellGap,padding:shellPad,boxSizing:"border-box",height:"100vh"}}>
        ...
        <div style={{flex:1,minWidth:0,height:"calc(100vh - "+(shellPad*2)+"px)",overflow:"hidden",borderRadius:20,border:"1px solid "+theme.c.border,boxShadow:"0 8px 40px rgba(0,0,0,0.12)",background:theme.c.bg}}>
