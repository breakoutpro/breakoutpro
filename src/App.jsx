...
function StockDetail(props){
  ...
  return(
    <div>
      ...
      {/* OHLCV quick strip */}
      <div style={{display:"flex",gap:0,background:"#0F0F0F",borderBottom:"1px solid #1A1A1A",overflow:"hidden"}}>
      ...
      <div style={{background:"#0F0F0F",borderBottom:"1px solid #1A1A1A",padding:"6px 9px"}}>
        <div style={{display:"flex",gap:4,marginBottom:5}}>
          {[["1","Candle"],["3","Line"],["2","Bar"]].map(function(item){return(
            <button key={item[0]} onClick={function(){setChartType(item[0]);}} style={{background:chartType===item[0]?"#22C55E20":"transparent",border:"1px solid "+(chartType===item[0]?"#22C55E":"#222222"),borderRadius:6,padding:"3px 8px",color:chartType===item[0]?"#22C55E":"#445",fontSize:8,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>
              {item[1]}
            </button>
          );})}
          <div style={{flex:1}}></div>
          <div style={{fontSize:7,color:"#555",alignSelf:"center"}}>NSE:{st.sym}</div>
        </div>
        <div style={{display:"flex",gap:3,overflowX:"auto",paddingBottom:2}}>
          {[["1","1m"],["3","3m"],["5","5m"],["15","15m"],["30","30m"],["60","1h"],["240","4h"],["D","1D"],["W","1W"],["M","1M"]].map(function(item){return(
            <button key={item[0]} onClick={function(){setTf(item[0]);}} style={{background:tf===item[0]?"linear-gradient(135deg,#22C55E,#00b377)":"#161616",border:"1px solid "+(tf===item[0]?"#22C55E":"#222222"),borderRadius:7,padding:"4px 7px",color:tf===item[0]?"#000":"#445",fontSize:8,fontWeight:tf===item[0]?800:400,cursor:"pointer",fontFamily:"inherit",flexShrink:0}}>
              {item[1]}
            </button>
          );})}
        </div>
      ...
      {/* TradingView Chart */}
      <div style={{position:"relative",width:"100%",height:340,background:"#161616"}}>
        <iframe
      ...
      <div style={{padding:"8px 9px 0"}}>
        ...
        {/* ── TRADE ON BROKER ── */}
        <div style={{background:"linear-gradient(135deg,#0a1a0a,#001a0a)",border:"1px solid #2A2A2A",borderRadius:14,padding:"13px",marginBottom:8}}>
          <div style={{fontSize:10,fontWeight:800,color:"#22C55E",marginBottom:3}}>📈 Trade This Stock</div>
...
export default function StocksBuddy(){
  ...
  return(
    <div style={PS}>
        ...
        <div style={{position:"absolute",top:0,left:0,right:0,bottom:0,zIndex:200,display:"flex"}}>
          <div style={{width:245,background:"#0F0F0F",borderRight:"1px solid #111",display:"flex",flexDirection:"column",animation:"slideIn 0.22s ease"}}>
            ...
            <div style={{padding:"10px 9px",borderTop:"1px solid #1A1A1A"}}>
              ...
              <button onClick={function(){setPhase("auth");setUser(null);setSidebar(false);setIsAdmin(false);setOtpSt("form");setForm({name:"",email:"",phone:"",pass:"",confirm:""});}} style={{width:"100%",background:"#150505",border:"1px solid #2A2A2A",borderRadius:9,padding:"8px",color:"#ff5555",fontSize:10,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>
                🚪 Logout
              </button>
            </div>
          </div>
      ...
      <div style={{display:"flex",alignItems:"center",padding:"8px 9px 6px",borderBottom:"1px solid #1A1A1A",background:"#0B0B0B",borderBottom:"1px solid #1E1E1E",zIndex:50,flexShrink:0}}>
      ...
      <div style={{background:"#050200",borderBottom:"1px solid #ff440012",overflow:"hidden",flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center"}}>
          <div style={{background:"#222",color:"#22C55E",fontSize:7,fontWeight:700,padding:"3px 7px",flexShrink:0,letterSpacing:1,borderRight:"1px solid #333"}}>LIVE</div>
        ...
        {tab==="home"&&(
          <div>
            <div style={{padding:"14px 12px 8px 12px"}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  <div style={{width:42,height:42,borderRadius:"50%",background:"linear-gradient(135deg,#22C55E,#00aa00)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,fontWeight:800,color:"#000"}}>{(user&&user.name?user.name[0]:"U").toUpperCase()}</div>
                  <div>
                ...
                <div style={{display:"flex",gap:8,alignItems:"center"}}>
                  <button onClick={function(){setTab("news");}} style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:10,width:36,height:36,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",position:"relative"}}>
                  ...
                  <button onClick={function(){setSidebar(true);}} style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:10,width:36,height:36,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontSize:14}}>&#9776;</button>
                </div>
              </div>
            </div>

            {/* ── AI DAILY BRIEFING ── */}
            <div style={{margin:"0 12px 12px",background:"#161616",border:"1px solid #2A2A2A",borderRadius:14,padding:"13px",position:"relative",overflow:"hidden"}}>
              {/* glow bg */}
              <div style={{position:"absolute",top:-20,right:-20,width:80,height:80,background:"#22C55E15",borderRadius:"50%",filter:"blur(20px)"}}></div>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
                <div style={{display:"flex",alignItems:"center",gap:7}}>
                  <div style={{width:28,height:28,borderRadius:"50%",background:"linear-gradient(135deg,#22C55E,#00aa00)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13}}>&#129302;</div>
                  <div>
                    <div style={{fontSize:10,fontWeight:800,color:"#22C55E"}}>AI Market Briefing</div>
                    <div style={{fontSize:7,color:"#777"}}>{new Date().toLocaleDateString("en-IN",{weekday:"long",day:"numeric",month:"short"})}</div>
                  </div>
                </div>
                {!briefingLoading&&!briefingText&&(
                  <button onClick={function(){loadBriefing();}} style={{background:"#22C55E18",border:"1px solid #2A2A2A",borderRadius:8,padding:"4px 10px",color:"#22C55E",fontSize:8,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Get Briefing</button>
                )}
                {briefingLoading&&<div style={{fontSize:8,color:"#22C55E"}}>&#128260; Loading...</div>}
              </div>

              {!briefingText&&!briefingLoading&&(
                <div style={{background:"#080d08",borderRadius:10,padding:"12px",textAlign:"center"}}>
                  <div style={{fontSize:22,marginBottom:6}}>&#127774;</div>
                  <div style={{fontSize:11,color:"#888",fontWeight:600,marginBottom:4}}>Your Daily Market Briefing</div>
                  <div style={{fontSize:9,color:"#555",lineHeight:1.6,marginBottom:10}}>
                  ...
                  <button onClick={function(){loadBriefing();}} style={{background:"linear-gradient(135deg,#22C55E,#00b377)",border:"none",borderRadius:10,padding:"10px 24px",color:"#000",fontSize:11,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>
                    &#129302; Get My Briefing
                  </button>
                </div>
              )}
              ...
              {briefingLoading&&(
                <div style={{padding:"16px 0",textAlign:"center"}}>
                  ...
                  <div style={{fontSize:10,color:"#22C55E",fontWeight:700,marginBottom:4}}>AI is analyzing markets...</div>
                  <div style={{fontSize:8,color:"#777"}}>{user&&user.name?user.name.split(" ")[0]:""} ke liye personalized briefing ban rahi hai</div>
                  <div style={{marginTop:10,height:3,background:"#111",borderRadius:3,overflow:"hidden"}}>
                    <div style={{height:"100%",width:"100%",background:"linear-gradient(90deg,transparent,#22C55E,transparent)",animation:"ticker 1.5s linear infinite"}}></div>
                  </div>
                </div>
              )}
              ...
              {briefingText&&!briefingLoading&&(
                <div>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:10,paddingTop:8,borderTop:"1px solid #1a1a1a"}}>
                    <div style={{fontSize:7,color:"#555"}}>&#9888; Educational only. Not investment advice.</div>
                    <button onClick={function(){loadBriefing();}} style={{background:"#22C55E18",border:"1px solid #2A2A2A",borderRadius:7,padding:"3px 8px",color:"#22C55E",fontSize:8,cursor:"pointer",fontFamily:"inherit"}}>&#8635; Refresh</button>
                  </div>
                </div>
              )}
            </div>

            <div style={{margin:"6px 12px 10px 12px",padding:"10px 12px",background:"#161616",border:"1px solid #2A2A2A",borderRadius:12,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div style={{display:"flex",alignItems:"center",gap:8}}>
                <div style={{width:8,height:8,borderRadius:"50%",background:mktStatus.color,boxShadow:"none"}}></div>
                <div>
              ...
              <div style={{textAlign:"right"}}>
                ...
                <div style={{fontSize:11,fontWeight:700,color:"#22C55E",fontFamily:"monospace"}}>{clk}</div>
              </div>
            </div>

            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,margin:"0 12px 10px 12px"}}>
              <div onClick={function(){setTab("oi");setOiView("chain");setOiIdx("BANKNIFTY");setOiIdx("NIFTY");}} style={{background:"#161616",border:"1px solid "+(nifty.chg>=0?"#22C55E44":"#ff444444"),borderRadius:13,padding:"12px",cursor:"pointer"}}>
                ...
                <div style={{fontSize:10,fontWeight:700,color:nifty.chg>=0?"#22C55E":"#EF4444"}}>{nifty.chg>=0?"+":""}{nifty.chg.toFixed(2)} ({nifty.pct.toFixed(2)}%)</div>
              </div>
              <div onClick={function(){setTab("oi");setOiView("chain");}} style={{background:"#161616",border:"1px solid "+(sensex.chg>=0?"#22C55E44":"#ff444444"),borderRadius:13,padding:"12px",cursor:"pointer"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
                ...
                <div style={{fontSize:10,fontWeight:700,color:sensex.chg>=0?"#22C55E":"#EF4444"}}>{sensex.chg>=0?"+":""}{sensex.chg.toFixed(2)} ({sensex.pct.toFixed(2)}%)</div>
              </div>
            </div>
            ...
            <div style={{margin:"8px 9px 10px"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7}}>
                <div onClick={function(){setTab("oi");setOiView("chain");setOiIdx("NIFTY");}} style={{background:"#161616",border:"1px solid "+(nifty.up?"#22C55E33":"#ff444433"),borderRadius:11,padding:"11px 12px",cursor:"pointer"}}>
                  ...
                  <div style={{fontSize:10,fontWeight:700,color:nifty.up?"#22C55E":"#EF4444",marginTop:3}}>{nifty.up?"\u25B2":"\u25BC"} {nifty.up?"+":""}{nifty.chg.toFixed(2)} ({nifty.pct.toFixed(2)}%)</div>
                  <div style={{fontSize:7,color:"#666",marginTop:2}}>Tap for chart</div>
                </div>
                <div style={{background:"#161616",border:"1px solid "+(sensex.up?"#22C55E33":"#ff444433"),borderRadius:11,padding:"11px 12px"}}>
                  ...
                  <div style={{fontSize:10,fontWeight:700,color:sensex.up?"#22C55E":"#EF4444",marginTop:3}}>{sensex.up?"\u25B2":"\u25BC"} {sensex.up?"+":""}{sensex.chg.toFixed(2)} ({sensex.pct.toFixed(2)}%)</div>
                  <div style={{fontSize:7,color:"#666",marginTop:2}}>BSE | Real-time</div>
                </div>
                <div style={{background:"#161616",border:"1px solid #FFD70022",borderRadius:11,padding:"11px 12px"}}>
                  ...
                  <div style={{fontSize:10,fontWeight:700,color:giftNifty.up?"#22C55E":"#EF4444",marginTop:3}}>{giftNifty.up?"\u25B2":"\u25BC"} {giftNifty.up?"+":""}{giftNifty.chg.toFixed(2)} ({giftNifty.pct.toFixed(2)}%)</div>
                  <div style={{fontSize:7,color:"#666",marginTop:2}}>Pre-mkt indicator</div>
                </div>
                <div style={{background:"#161616",border:"1px solid #a78bfa33",borderRadius:11,padding:"11px 12px"}}>
                  ...
                  <div style={{fontSize:10,fontWeight:700,color:vix>15?"#EF4444":vix>13?"#F59E0B":"#22C55E",marginTop:3}}>{vix>15?"High Fear":vix>13?"Caution":"Low Fear"}</div>
                  <div style={{fontSize:7,color:"#666",marginTop:2}}>Volatility index</div>
                </div>
              </div>
            </div>
            ...
            <div style={{margin:"0 9px 10px"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:7}}>
                ...
                <button onClick={function(){setTab("news");}} style={{background:"none",border:"none",color:"#22C55E",fontSize:9,cursor:"pointer",fontFamily:"inherit"}}>View All &#8250;</button>
              </div>
              {(liveNewsAPI.length>0?liveNewsAPI:NEWS).slice(0,4).map(function(n,i){
                return(
                  <div key={i} style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:10,padding:"10px 11px",marginBottom:6,display:"flex",gap:8,alignItems:"flex-start"}}>
                    <div style={{background:"#22C55E15",border:"1px solid #2A2A2A",borderRadius:6,padding:"3px 6px",fontSize:6,fontWeight:700,color:"#22C55E",flexShrink:0,marginTop:2}}>{(n.cat||"MKT").substring(0,4).toUpperCase()}</div>
                    <div style={{flex:1}}>
                      <div style={{fontSize:10,fontWeight:700,color:"#e8e8e8",lineHeight:1.4,marginBottom:2}}>{n.title}</div>
                      <div style={{fontSize:8,color:"#666"}}>{n.time}</div>
                    </div>
                  </div>
                );
              })}
            ...
            <div style={{margin:"8px 9px 0",background:isHoliday?"#1a1200":showMCX?"#0a0800":"#0a1a0a",border:"1px solid "+(isHoliday?"#f59e0b44":showMCX?"#f59e0b44":"#22C55E33"),borderLeft:"4px solid "+mktStatus.color,borderRadius:12,padding:"9px 12px",display:"flex",gap:10,alignItems:"center"}}>
              <div style={{width:8,height:8,borderRadius:"50%",background:mktStatus.color,flexShrink:0}}></div>
              <div>
                <div style={{fontSize:11,fontWeight:800,color:mktStatus.color}}>{mktStatus.label}</div>
                <div style={{fontSize:9,color:"#777",marginTop:1}}>{mktStatus.sub}</div>
              </div>
            </div>

            {(showStocks||mktStatus.session==="gift")&&(
              <div style={{margin:"6px 9px 0",display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:5}}>
                <div style={{background:"#161616",border:"1px solid #60a5fa33",borderRadius:9,padding:"7px"}}>
                  <div style={{fontSize:7,color:"#666",marginBottom:1}}>Gift Nifty</div>
                  <div style={{fontFamily:"monospace",fontSize:11,fontWeight:800,color:"#fff"}}>{fN(giftNifty.ltp)}</div>
                  <div style={{fontSize:8,fontWeight:700,color:giftNifty.up?"#22C55E":"#EF4444"}}>{giftNifty.up?"+":"-"}{giftNifty.pct.toFixed(2)}%</div>
                </div>
                <div style={{background:"#161616",border:"1px solid #f59e0b33",borderRadius:9,padding:"7px"}}>
                  <div style={{fontSize:7,color:"#666",marginBottom:1}}>India VIX</div>
                  <div style={{fontFamily:"monospace",fontSize:11,fontWeight:800,color:"#fff"}}>{vix.toFixed(2)}</div>
                  <div style={{fontSize:8,color:vix<15?"#22C55E":vix<20?"#F59E0B":"#EF4444"}}>{vix<15?"Low Fear":vix<20?"Moderate":"High Fear"}</div>
                </div>
                <div style={{background:"#161616",border:"1px solid #2A2A2A",borderRadius:9,padding:"7px"}}>
                  <div style={{fontSize:7,color:"#666",marginBottom:1}}>PCR</div>
                  <div style={{fontFamily:"monospace",fontSize:11,fontWeight:800,color:"#22C55E"}}>1.24</div>
                  <div style={{fontSize:8,color:"#22C55E"}}>Bullish</div>
                </div>
                <div style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:9,padding:"7px"}}>
                  <div style={{fontSize:7,color:"#666",marginBottom:1}}>FII</div>
                  <div style={{fontFamily:"monospace",fontSize:11,fontWeight:800,color:"#22C55E"}}>Buy</div>
                  <div style={{fontSize:8,color:"#22C55E"}}>+8245 Cr</div>
                </div>
              </div>
            )}
            ...
            {showStocks&&(
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7,padding:"6px 9px 0"}}>
                {[{n:"NIFTY 50",d:nifty},{n:"SENSEX",d:sensex}].map(function(item){
                  return(<div key={item.n} style={{background:item.d.up?"#0a1a0a":"#1a0a0a",border:"1px solid "+(item.d.up?"#22C55E22":"#ff444422"),borderRadius:12,padding:"10px"}}>
                    <div style={{fontSize:8,color:"#666",fontWeight:600,marginBottom:2}}>{item.n}</div>
                    <div style={{fontFamily:"monospace",fontSize:15,fontWeight:800,color:"#fff"}}>{fN(item.d.ltp)}</div>
                    <div style={{fontSize:10,fontWeight:700,color:item.d.up?"#22C55E":"#EF4444",marginTop:1}}>{item.d.up?"+":"-"}{fN(item.d.chg)} ({item.d.pct.toFixed(2)}%)</div>
                  </div>);
                })}
              </div>
            )}
              ...
              <div style={{padding:"6px 9px 0"}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:7}}>
                  {mcx.map(function(c){
                    var up=c.chgPct>=0;
                    return(
                      <div key={c.sym} style={{background:"#161616",border:"1px solid "+(up?"#f59e0b33":"#ff444422"),borderRadius:12,padding:"10px",cursor:"pointer"}}>
                        <div style={{display:"flex",justifyContent:"space-between",marginBottom:5}}>
                          <div style={{fontSize:9,fontWeight:800,color:"#F59E0B"}}>{c.sym}</div>
                          <div style={{fontSize:8,fontWeight:700,color:up?"#22C55E":"#EF4444"}}>{up?"+":""}{c.chgPct.toFixed(2)}%</div>
                        </div>
                        <div style={{fontFamily:"monospace",fontSize:13,fontWeight:800,color:"#fff"}}>Rs{fN(c.ltp)}</div>
                        <div style={{fontSize:7,color:"#666",marginTop:1}}>{c.unit}</div>
                        <div style={{marginTop:5}}><Spark data={c.spark} color={up?"#F59E0B":"#EF4444"} h={22} w={100}/></div>
                      </div>
                    );
                  })}
                </div>
            ...
            {NEWS.slice(0,3).map(function(n){
              return(
                <div key={n.id} style={{margin:"0 9px 6px",background:"#161616",border:"1px solid #1a1a1a",borderRadius:12,padding:"11px"}}>
                  <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                    <span style={{fontSize:7,color:"#22C55E",fontWeight:700,background:"#22C55E15",border:"1px solid #2A2A2A",borderRadius:6,padding:"2px 6px"}}>{n.cat}</span>
                    <span style={{fontSize:7,color:"#555"}}>{n.time}</span>
                  </div>
                  <div style={{fontSize:12,fontWeight:700,color:"#fff",lineHeight:1.4,marginBottom:3}}>{n.title}</div>
                  <div style={{fontSize:9,color:"#777",lineHeight:1.5}}>{n.body}</div>
                </div>
              );
            })}

            <div style={{margin:"10px 9px 0",background:"#161616",border:"1px solid #ff440044",borderRadius:14,padding:"12px"}}>
              ...
              {liveAlerts.length===0?(
                <div style={{textAlign:"center",padding:"15px 0",color:"#666",fontSize:10}}>Waiting for first alert...</div>
              ):(
                <div>
                  {liveAlerts.slice(0,isPrem?5:1).map(function(a){
                    return(
                      <div key={a.id} style={{background:"#161616",border:"1px solid "+a.color+"33",borderRadius:10,padding:"9px",marginBottom:5,position:"relative",opacity:isPrem?1:0.7}}>
                        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
                          ...
                          <span style={{fontSize:8,color:"#666"}}>{a.time}</span>
                        </div>
                        <div style={{fontSize:10,color:"#ccc",marginBottom:3}}>{a.msg}</div>
                        {isPrem&&(
                          <div style={{background:"#161616",border:"1px solid #2A2A2A",borderRadius:6,padding:"5px 7px",marginTop:5}}>
                            <div style={{fontSize:7,color:"#22C55E",fontWeight:700,marginBottom:2}}>EASY GUIDANCE</div>
            ...
            {showStocks&&(
              <div style={{padding:"0 9px"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8,paddingTop:6}}>
                  <div style={{display:"flex",background:"#161616",borderRadius:20,padding:3,border:"1px solid #1a1a1a"}}>
                  ...
                  <button onClick={function(){setTab("markets");}} style={{background:"none",border:"none",color:"#22C55E",fontSize:9,cursor:"pointer",fontFamily:"inherit"}}>View All &#8250;</button>
                </div>
                <div style={{display:"flex",gap:6,marginBottom:10}}>
                  {[["Large","Large Cap"],["Mid","Mid Cap"]].map(function(kl){return(<button key={kl[0]} onClick={function(){setCapFil(kl[0]);}} style={{background:capFil===kl[0]?"#22C55E18":"#161616",border:"1.5px solid "+(capFil===kl[0]?"#22C55E":"#222222"),borderRadius:20,padding:"5px 12px",color:capFil===kl[0]?"#22C55E":"#445",fontSize:9,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>{kl[1]}</button>);})}
                </div>
          ...
          <div>
            ...
            {oiView==="chart"&&(
              <div style={{padding:"0 9px 10px"}}>
                <div style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:13,padding:"10px",marginBottom:8}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                    <div>
                      <div style={{fontSize:12,fontWeight:800,color:"#22C55E"}}>NIFTY 50 — Live Chart</div>
                      <div style={{fontSize:8,color:"#777"}}>Real-time | NSE</div>
                    </div>
                    <div style={{background:"#22C55E22",border:"1px solid #22C55E55",borderRadius:8,padding:"3px 8px"}}>
                ...
                <div style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:13,padding:"10px"}}>
                  <div style={{fontSize:12,fontWeight:800,color:"#3B82F6",marginBottom:8}}>BANK NIFTY — Live Chart</div>
            ...
            {oiView==="chain"&&(
              <div>
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:4,padding:"0 9px 7px"}}>
                  {[["Max Pain",oiIdx==="NIFTY"?"22,500":"48,200","#F59E0B"],["PCR",oiIdx==="NIFTY"?"1.24":"0.88",oiIdx==="NIFTY"?"#22C55E":"#EF4444"],["CE OI","65.4Cr","#FCA5A5"],["PE OI","53.2Cr","#88ff88"]].map(function(item){return(
                    <div key={item[0]} style={{background:"#161616",border:"1px solid #1a1a1a",borderRadius:8,padding:"8px 4px",textAlign:"center"}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,background:"rgba(0,0,0,0.98)",borderTop:"1px solid #1A1A1A",display:"flex",justifyContent:"space-around",padding:"5px 3px 10px",zIndex:100}}>
        {[["home","&#127968;","home"],["markets","&#128200;","markets"],["oi","&#128202;","oi"],["scanner","&#128209;","scanner"],["tools","&#128295;","tools"],["news","&#128240;","news"],["learn","&#128218;","learn"]].concat(isAdmin?[["admin","&#128081;","admin"]]:[]).map(function(item){
          return(<button key={item[0]} onClick={function(){setSelSt(null);setTab(item[0]);}} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2,background:tab===item[0]?"#22C55E12":"transparent",border:"none",cursor:"pointer",padding:"4px 3px",borderRadius:9,minWidth:36,fontFamily:"inherit"}}>
            <span style={{fontSize:16}} dangerouslySetInnerHTML={{__html:item[1]}}></span>
            <span style={{fontSize:7,color:tab===item[0]?"#22C55E":"#445",fontWeight:600,whiteSpace:"nowrap"}}>{t(item[2])}</span>
          </button>);
        })}
      </div>
    ...
    {phase==="app"&&chatOpen&&(
      <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:250,display:"flex",flexDirection:"column",background:"#0B0B0B",maxWidth:430,margin:"0 auto"}}>
        ...
        {/* Chat Header */}
        <div style={{background:"#111122",borderBottom:"1px solid #222233",padding:"12px 14px",display:"flex",alignItems:"center",gap:10,flexShrink:0}}>
          <div style={{width:42,height:42,borderRadius:12,background:"#161616",border:"1px solid #303030",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",flexShrink:0,gap:1}}>
              <div style={{fontFamily:"Arial,sans-serif",fontSize:11,fontWeight:900,color:"#fff",letterSpacing:-0.5,lineHeight:1}}>B<span style={{color:"#22C55E"}}>P</span></div>
              <div style={{fontSize:7,fontWeight:800,color:"#22C55E",letterSpacing:0.5}}>AI</div>
            </div>
          <div style={{flex:1}}>
            <div style={{fontSize:13,fontWeight:800,color:"#fff"}}>Breakout Pro AI</div>
            <div style={{fontSize:8,color:"#3B82F6",display:"flex",alignItems:"center",gap:4}}>
        ...
        {/* Disclaimer banner */}
        <div style={{background:"#111",borderBottom:"1px solid #1E1E1E",padding:"6px 14px",display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
          <span style={{fontSize:10}}>&#9888;&#65039;</span>
          <span style={{fontSize:8,color:"#666",lineHeight:1.4}}>Educational Purpose Only. Not SEBI Registered Investment Advice.</span>
        </div>
        ...
        <div style={{flex:1,overflowY:"auto",padding:"10px 12px"}}>
          {chatMsgs.length===0&&(
            <div>
              <div style={{textAlign:"center",padding:"20px 10px 14px"}}>
                ...
                <div style={{fontSize:9,color:"#777",lineHeight:1.6}}>Ask me anything about stock market education. I explain concepts in simple language.</div>
              </div>
              <div style={{fontSize:9,color:"#22C55E",fontWeight:700,marginBottom:8,textAlign:"center",letterSpacing:0.5}}>QUICK QUESTIONS</div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
                {QUICK_QUESTIONS.map(function(q){return(
                  <button key={q} onClick={function(){sendGemini(q);}} style={{background:"#0d0d1a",border:"1px solid #222233",borderRadius:9,padding:"8px",cursor:"pointer",textAlign:"left",fontFamily:"inherit"}}>
            ...
            return(
              <div key={i} style={{marginBottom:10,display:"flex",flexDirection:"column",alignItems:isUser?"flex-end":"flex-start"}}>
                <div style={{
                  ...
                  border:isUser?"none":"1px solid #222233",
          ...
          {chatLoading&&(
            <div style={{display:"flex",alignItems:"flex-start",marginBottom:10}}>
              <div style={{background:"#0d0d1a",border:"1px solid #222233",borderRadius:"14px 14px 14px 4px",padding:"12px 16px"}}>
                <div style={{display:"flex",alignItems:"center",gap:5,marginBottom:6}}>
                  <span style={{fontSize:11}}>&#129302;</span>
                  <span style={{fontSize:8,color:"#3B82F6",fontWeight:700}}>Thinking...</span>
                </div>
                <div style={{display:"flex",gap:4,alignItems:"center"}}>
                  {[0,1,2].map(function(i){return(
                    <div key={i} style={{width:7,height:7,borderRadius:"50%",background:"#3B82F6",opacity:0.6,animation:"bpPulse 1.2s ease infinite",animationDelay:(i*0.2)+"s"}}></div>
                  );})}
                </div>
              </div>
            </div>
        ...
        {/* Input area */}
        <div style={{borderTop:"1px solid #1a1a1a",padding:"10px 12px",background:"#0F0F0F",flexShrink:0}}>
          {/* Quick chips */}
          <div style={{display:"flex",gap:5,overflowX:"auto",marginBottom:8,paddingBottom:2}}>
            {["Explain Doji","What is OI?","Explain PCR","What is Theta?","Gap Up pattern","Explain VWAP"].map(function(q){return(
              <button key={q} onClick={function(){sendGemini(q);}} style={{background:"#0d0d1a",border:"1px solid #222233",borderRadius:16,padding:"4px 10px",color:"#3B82F6",fontSize:8,fontWeight:600,cursor:"pointer",whiteSpace:"nowrap",flexShrink:0,fontFamily:"inherit"}}>{q}</button>
            );})}
          </div>
          <div style={{display:"flex",gap:8,alignItems:"flex-end"}}>
            <textarea
              ...
              rows={1}
              style={{flex:1,background:"#0d0d1a",border:"1px solid #222233",borderRadius:11,padding:"10px 12px",color:"#fff",fontSize:11,fontFamily:"inherit",outline:"none",resize:"none",lineHeight:1.4,maxHeight:80,overflowY:"auto"}}
            />
          ...
          <div style={{display:"flex",justifyContent:"space-between",marginTop:6,alignItems:"center"}}>
            ...
            {chatMsgs.length>0&&<button onClick={function(){setChatMsgs([]);try{localStorage.removeItem("bp_chat");}catch(e){}}} style={{background:"none",border:"none",color:"#555",fontSize:8,cursor:"pointer",fontFamily:"inherit"}}>Clear chat</button>}
          </div>
        </div>
      </div>
    )}
