...
export function SectionHead(props){
  ...
  return (
    <div style={{fontSize:12,color:MT.T2,fontWeight:800,margin:wide?"8px 0 4px":"22px 0 10px",letterSpacing:0.5}}>
      {props.children}
    </div>
  );
}
...
export function SectionHeadWithPill(props){
  ...
  var wide = responsive.isDesktop || responsive.isTV;
  return (
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",rowGap:6,margin:wide?"8px 0 4px":"22px 0 10px"}}>
