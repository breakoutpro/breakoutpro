...
export default function MorningPulse(props){
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      {/* HEADER */}
      <div style={{background:"#050816",padding:"14px 16px",borderBottom:"1px solid "+BD}}>
        ...
        <div style={{background:"#0A1A0F",border:"1px solid rgba(0,200,83,0.18)",borderRadius:16,padding:"14px",marginBottom:12}}>
