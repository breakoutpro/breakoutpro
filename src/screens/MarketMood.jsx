  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{background:MT.CARD,borderBottom:"1px solid "+MT.BD,position:"sticky",top:0,zIndex:5}}>
        <div style={{display:"flex",alignItems:"center",gap:10,padding:wideLayout?"3px 10px":"6px 12px",maxWidth:1600,margin:"0 auto",boxSizing:"border-box"}}>
      ...
      <div style={{padding:wideLayout?"3px 8px":"10px 12px 16px",maxWidth:1600,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
          ...
          <div style={{marginBottom:wideLayout?0:8}}>
            <SectionHead>
              <span style={{display:"inline-flex",alignItems:"center",gap:5}}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke={MT.T2} strokeWidth="2.4" strokeLinecap="round" style={{flexShrink:0}}>
