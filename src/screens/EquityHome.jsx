        ...
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:7,flex:1,minWidth:0}}>
            <div style={{flex:1,display:"flex",alignItems:"center",background:CARD,border:"1px solid "+BD,borderRadius:12,padding:"0 12px",height:38,gap:7,minWidth:0}}>
              ...
              <input placeholder="Search stocks, indices, news..." style={{background:"none",border:"none",outline:"none",color:T1,fontSize:11,fontFamily:"inherit",flex:1,minWidth:0}} readOnly/>
            </div>
