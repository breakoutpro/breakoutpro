...
export default function App() {
  ...
  var MORE_SCREENS = ["global","heatmap","fiidii","journal","challenges","sub","tools","candle","chart","detector","analysis","scalper","quiz","briefing","oi","alerts","settings","patterns","paper"];
  useEffect(function(){
    function onBack(e){
      e.preventDefault();
