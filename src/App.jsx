          ...
          <div>
            <div style={{margin:"8px 9px",background:"#0d0d0d",border:"1px solid #1a1a1a",borderRadius:14,padding:"10px"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <div>
                  <div style={{fontSize:11,fontWeight:800,color:"#39FF14"}}>NIFTY 50 Live Chart</div>
                  <div style={{fontSize:8,color:"#445"}}>5-min candles | TradingView</div>
                </div>
              ...
              <div style={{position:"relative",width:"100%",height:"320px",borderRadius:10,overflow:"hidden"}}>
                <iframe 
                  src="https://s.tradingview.com/widgetembed/?frameElementId=tv-chart&symbol=NSE%3ANIFTY&interval=5&hidesidetoolbar=1&symboledit=1&saveimage=1&toolbarbg=000000&studies=%5B%5D&theme=dark&style=1&timezone=Asia%2FKolkata&studies_overrides=%7B%7D&overrides=%7B%7D&enabled_features=%5B%5D&disabled_features=%5B%5D&locale=en"
              ...
              <div style={{marginTop:7,fontSize:8,color:"#445",textAlign:"center"}}>Educational use only. Data via TradingView.</div>
            </div>
