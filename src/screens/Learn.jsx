...
function Disclaimer(){
  ...
  return (
    <div style={{background:"rgba(249,115,22,0.08)",border:"1px solid rgba(249,115,22,0.2)",borderRadius:10,padding:10,marginTop:6}}>
      <div style={{fontSize:8,color:theme.c.warn}}>{DISC}</div>
    </div>
  );
}
...
export default function LearnScreen(){
  ...
  return (
    <div style={{background:DB,minHeight:"100%",paddingBottom:80,fontFamily:"Inter,Arial,sans-serif"}}>
      <div style={{padding:14}}>
        <div style={{fontSize:20,fontWeight:900,color:T1,marginBottom:4}}>Learn <span style={{color:BLUE}}>Trading</span></div>
        ...
        <div style={{background:"linear-gradient(135deg,#0F1629,#101A2A)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:14,padding:14,marginBottom:14}}>
          <div style={{fontSize:10,color:BLUE,fontWeight:700,marginBottom:6}}>Today's Lesson</div>
