      ...
      <div style={{padding:"16px 16px 10px"}}>
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0}}>
            <div style={{width:36,height:36,borderRadius:10,background:"linear-gradient(135deg,#1E3A8A,#1D4ED8)",border:"1px solid rgba(77,166,255,0.4)",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 0 12px rgba(77,166,255,0.2)"}}>
              <span style={{fontSize:13,fontWeight:900,color:"#fff",letterSpacing:-0.5}}>BP</span>
            </div>
          ...
          <div style={{display:"flex",alignItems:"center",gap:7,flex:1,minWidth:0}}>
            <div onClick={function(){setTab("search");}} style={{flex:1,display:"flex",alignItems:"center",background:CARD,border:"1px solid "+BD,borderRadius:12,padding:"0 12px",height:38,gap:7,minWidth:0,cursor:"pointer"}}>
              <span style={{fontSize:13,color:T3,flexShrink:0}}>&#128269;</span>
              <span style={{fontSize:11,color:T3,flex:1}}>Search stocks, indices, news...</span>
            </div>
