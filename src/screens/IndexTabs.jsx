...
export default function IndexTabs(props) {
  ...
  if(vt=="pattern") return (
    <div>
      {pat?(
        <div style={{background:"linear-gradient(135deg,#0A1020,#0B1224)",border:"1px solid "+(pat.type=="bullish"?G:pat.type=="bearish"?R:GOLD)+"44",borderRadius:16,padding:16,marginBottom:12}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
            <div style={{fontSize:18,fontWeight:900,color:T1}}>{pat.name}</div>
            <span style={{background:pat.type=="bullish"?"rgba(0,200,83,0.15)":pat.type=="bearish"?"rgba(239,68,68,0.15)":"rgba(245,158,11,0.15)",color:pat.type=="bullish"?G2:pat.type=="bearish"?R:GOLD,borderRadius:20,padding:"4px 12px",fontSize:10,fontWeight:700}}>{pat.signal}</span>
          </div>
