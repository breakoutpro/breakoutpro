          ...
          return (
            <div key={r.id} style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:14,marginBottom:10}}>
              ...
              <div style={{display:"flex",gap:8,marginTop:8}}>
                <button onClick={function(){alerts.toggleEnabled(r.id);}} style={{flex:1,background:"transparent",border:"1px solid "+(r.enabled?BLUE:T3),borderRadius:8,padding:"9px 4px",color:r.enabled?BLUE:T3,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit",minHeight:44}}>{r.enabled?"Enabled":"Disabled"}</button>
