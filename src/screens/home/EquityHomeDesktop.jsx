            ...
            {(function(){
              ...
              return (
                <div style={{display:"flex",flexDirection:"column",flex:1,minHeight:0}}>
                  ...
                  <div style={{fontSize:18,fontWeight:900,color:moodColor,marginBottom:3}}>{mood.label.toUpperCase()}</div>
            ...
            if(!hasRange){
              ...
              rangeContent = (
                <div>
                  ...
                  <div style={{fontSize:18,fontWeight:900,color:T1,marginBottom:2}}>{nifty.ltp.toLocaleString("en-IN")}</div>
