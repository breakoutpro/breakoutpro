...
function Toggle(props){
  return (
    <div onClick={props.onChange} style={{width:44,height:24,borderRadius:12,background:props.value?G:"rgba(255,255,255,0.1)",border:"1px solid "+(props.value?G:BD),cursor:"pointer",position:"relative",flexShrink:0}}>
