            ...
            {(function(){
              ...
              return (
                <div style={{display:"flex",gap:20}}>
                  ...
                  {usingDemo ? (
                    <div style={{width:170,flexShrink:0,background:CARD2,border:"1px solid "+BD,borderRadius:10,padding:10}}>
                      ...
                      <div style={{marginBottom:6}}><div style={{fontSize:9,color:T3}}>PCR</div><div style={{fontSize:12,fontWeight:800,color:T1}}>{DEMO_FNO.pcr} <span style={{fontSize:10,fontWeight:700,color:UP}}>{DEMO_FNO.pcrLabel}</span></div></div>
                      ...
                      <div style={{marginBottom:6}}><div style={{fontSize:9,color:T3}}>India VIX</div><div style={{fontSize:12,fontWeight:800,color:T1}}>{DEMO_DATA.indices.VIX.ltp} <span style={{fontSize:10,fontWeight:700,color:DOWN}}>{DEMO_DATA.indices.VIX.chgPct}%</span></div></div>
                      <div><div style={{fontSize:9,color:T3}}>FII Derivatives</div><div style={{fontSize:12,fontWeight:800,color:UP}}>+&#8377;{DEMO_FNO.fiiFlow.toLocaleString("en-IN")} Cr</div></div>
                    </div>
                  ) : null}
                </div>
              );
