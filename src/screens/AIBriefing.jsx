...
try {
  ...
  GEMINI_KEY = window.__GEMINI_KEY || "";
}
  ...
  function fetchBriefing() {
    ...
    .then(function(data){
      ...
      try {
        ...
        var errMsg = data.error ? data.error.message : "Empty response";
        throw new Error(errMsg);
      }
      if (!text || text.length < 10) throw new Error("Empty response from Gemini");
      setRaw(text);
      setBriefing(true);
