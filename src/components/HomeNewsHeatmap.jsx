var CARD="#111317", BD="rgba(103,232,249,0.08)";
    ...
    <div onClick={function(){setShowMorningPulse(true);}} style={{
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div style={{display:"flex",alignItems:"center",gap:9}}>
          <div style={{width:30,height:30,borderRadius:9,background:"rgba(103,232,249,0.08)",border:"1px solid "+BD,display:"flex",alignItems:"center",justifyContent:"center"}}>
