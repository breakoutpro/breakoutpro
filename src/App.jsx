...
const LANGS={en:"English",te:"Telugu",hi:"Hindi",ta:"Tamil"};
      ...
      {otpSt==="form"&&<div style={{padding:"14px 18px 32px"}}>
        ...
        <div style={{marginTop:14}}>
          ...
          <select value={lang} onChange={function(e){setLang(e.target.value);}} style={{width:"100%",background:"#0d0d0d",border:"1px solid #1a2a1a",borderRadius:10,padding:"10px",color:"#39FF14",fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit",outline:"none"}}>
            {Object.entries(LANGS).map(function(kl){return(<option key={kl[0]} value={kl[0]}>{kl[1]}</option>);})}
          </select>
        </div>
    ...
    <div style={PS}>
      ...
      <div style={{display:"flex",alignItems:"center",padding:"8px 9px 6px",borderBottom:"1px solid #0c0c0c",background:"rgba(0,0,0,0.98)",zIndex:50,flexShrink:0}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:5}}>
          ...
          <button onClick={function(){setShowNot(true);}} style={{background:unread>0?"#1a0500":"#0d0d0d",border:"1.5px solid "+(unread>0?"#ff4444":"#1a1a1a"),borderRadius:11,padding:"6px 10px",fontSize:17,cursor:"pointer",position:"relative",transition:"all 0.3s",animation:unread>0?"shake 1.5s infinite":"none"}}>
            <span style={{fontSize:18,filter:unread>0?"drop-shadow(0 0 5px #ff4444)":"none"}}>&#128276;</span>{unread>0&&<span style={{position:"absolute",top:-5,right:-5,background:"linear-gradient(135deg,#ff3333,#cc0000)",color:"#fff",fontSize:9,fontWeight:800,minWidth:18,height:18,padding:"0 4px",borderRadius:9,display:"flex",alignItems:"center",justifyContent:"center",border:"2px solid #000",boxShadow:"0 0 8px #ff333388"}}>{unread}</span>}
          </button>
            ...
            <div style={{margin:"8px 9px",background:"#0d0d0d",border:"1px solid #1a1a1a",borderRadius:14,padding:"10px"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <div>
                  ...
                  <div style={{fontSize:8,color:"#445"}}>Real-time | NSE | 5 Min Candles</div>
                </div>
              ...
              <div style={{position:"relative",width:"100%",height:"450px",borderRadius:10,overflow:"hidden",background:"#000"}}>
                <iframe src="https://www.tradingview-widget.com/embed-widget/advanced-chart/?locale=en#%7B%22autosize%22%3Atrue%2C%22symbol%22%3A%22NSE%3ANIFTY%22%2C%22interval%22%3A%225%22%2C%22timezone%22%3A%22Asia%2FKolkata%22%2C%22theme%22%3A%22dark%22%2C%22style%22%3A%221%22%2C%22locale%22%3A%22en%22%2C%22enable_publishing%22%3Afalse%2C%22hide_top_toolbar%22%3Afalse%2C%22hide_legend%22%3Afalse%2C%22save_image%22%3Afalse%2C%22studies%22%3A%5B%5D%2C%22show_popup_button%22%3Afalse%2C%22popup_width%22%3A%221000%22%2C%22popup_height%22%3A%22650%22%7D" style={{width:"100%",height:"100%",border:"none"}} allowTransparency="true" scrolling="no" allowFullScreen={true}></iframe>
              </div>
              <div style={{marginTop:7,padding:"7px 9px",background:"#0a1a0a",border:"1px solid #39FF1422",borderRadius:7,fontSize:8,color:"#aaa",lineHeight:1.5}}>
                <b style={{color:"#39FF14"}}>Pro Tip:</b> Inside chart - Tap symbol name to change stock. Tap timeframe to switch 1m/5m/15m/1h/1D. Educational only.
              </div>
            </div>
              ...
              {oiView==="chart"&&(
                <div style={{background:"#0d0d0d",border:"1px solid #1a1a1a",borderRadius:13,padding:"10px",marginBottom:10}}>
                  ...
                  <div style={{position:"relative",width:"100%",height:"400px",borderRadius:10,overflow:"hidden",background:"#000"}}>
                    <iframe src="https://www.tradingview-widget.com/embed-widget/advanced-chart/?locale=en#%7B%22autosize%22%3Atrue%2C%22symbol%22%3A%22NSE%3ANIFTY%22%2C%22interval%22%3A%225%22%2C%22timezone%22%3A%22Asia%2FKolkata%22%2C%22theme%22%3A%22dark%22%2C%22style%22%3A%221%22%2C%22locale%22%3A%22en%22%2C%22enable_publishing%22%3Afalse%2C%22hide_top_toolbar%22%3Afalse%2C%22hide_legend%22%3Afalse%2C%22save_image%22%3Afalse%2C%22studies%22%3A%5B%5D%2C%22show_popup_button%22%3Afalse%7D" style={{width:"100%",height:"100%",border:"none"}} allowTransparency="true" scrolling="no"></iframe>
                  </div>
                </div>
              )}
            </div>
            ...
            <div style={{padding:"14px 12px 8px 12px"}}>
              ...
              <div style={{background:"linear-gradient(135deg,#3a2a0a,#4a3a00)",border:"1px solid #ffaa4444",borderRadius:13,padding:"14px",marginBottom:10}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
                  <span style={{fontSize:22}}>&#127909;</span>
                  <div>
                    <div style={{fontSize:12,fontWeight:800,color:"#ffcc88"}}>YouTube Channels (Telugu/Hindi)</div>
                    <div style={{fontSize:8,color:"#666"}}>Free video tutorials</div>
                  </div>
                </div>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
                  <a href="https://www.youtube.com/@PRSentinel" target="_blank" rel="noopener" style={{background:"#0a0a0a",border:"1px solid #1a1a1a",borderRadius:9,padding:"10px 8px",textDecoration:"none",display:"block"}}><div style={{fontSize:14,marginBottom:3}}>&#127482;&#127475;</div><div style={{fontSize:9,fontWeight:700,color:"#fff",lineHeight:1.3}}>PR Sundar</div><div style={{fontSize:7,color:"#666",marginTop:3}}>Options pro</div></a>
                  <a href="https://www.youtube.com/@PushkarRajThakur" target="_blank" rel="noopener" style={{background:"#0a0a0a",border:"1px solid #1a1a1a",borderRadius:9,padding:"10px 8px",textDecoration:"none",display:"block"}}><div style={{fontSize:14,marginBottom:3}}>&#127482;&#127475;</div><div style={{fontSize:9,fontWeight:700,color:"#fff",lineHeight:1.3}}>Pushkar Raj</div><div style={{fontSize:7,color:"#666",marginTop:3}}>Hindi trading</div></a>
                  <a href="https://www.youtube.com/@CAR_RAVI_BHUSHAN_NIGAM" target="_blank" rel="noopener" style={{background:"#0a0a0a",border:"1px solid #1a1a1a",borderRadius:9,padding:"10px 8px",textDecoration:"none",display:"block"}}><div style={{fontSize:14,marginBottom:3}}>&#127482;&#127475;</div><div style={{fontSize:9,fontWeight:700,color:"#fff",lineHeight:1.3}}>CA Ravi Nigam</div><div style={{fontSize:7,color:"#666",marginTop:3}}>Tax+investing</div></a>
                  <a href="https://www.youtube.com/@MarketGuruIndia" target="_blank" rel="noopener" style={{background:"#0a0a0a",border:"1px solid #1a1a1a",borderRadius:9,padding:"10px 8px",textDecoration:"none",display:"block"}}><div style={{fontSize:14,marginBottom:3}}>&#127482;&#127475;</div><div style={{fontSize:9,fontWeight:700,color:"#fff",lineHeight:1.3}}>Market Guru</div><div style={{fontSize:7,color:"#666",marginTop:3}}>Technical</div></a>
                </div>
              </div>
      ...
      {showLangModal&&(
        <div onClick={function(){setShowLangModal(false);}} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"}}>
          <div onClick={function(e){e.stopPropagation();}} style={{background:"#0a0a0a",border:"1px solid #1a1a1a",borderRadius:14,padding:"18px",maxWidth:340,width:"100%"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
              <div>
                <div style={{fontSize:14,fontWeight:800,color:"#39FF14"}}>Select Language</div>
                <div style={{fontSize:9,color:"#445",marginTop:3}}>Choose your preferred language</div>
              </div>
              <button onClick={function(){setShowLangModal(false);}} style={{background:"#1a1a1a",border:"none",borderRadius:8,width:30,height:30,color:"#fff",fontSize:15,cursor:"pointer",fontFamily:"inherit"}}>&#10005;</button>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
              {Object.entries(LANGS).map(function(kl){return(
                <button key={kl[0]} onClick={function(){setLang(kl[0]);setShowLangModal(false);}} style={{background:lang===kl[0]?"#1a3a1a":"#0d0d0d",border:"1px solid "+(lang===kl[0]?"#39FF14":"#1a1a1a"),borderRadius:10,padding:"14px 10px",color:lang===kl[0]?"#39FF14":"#aaa",fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit",textAlign:"left"}}>
                  <div style={{fontSize:9,color:"#666",marginBottom:3,fontWeight:600,letterSpacing:1}}>{kl[0].toUpperCase()}</div>
                  <div>{kl[1]}</div>
                </button>
              );})}
            </div>
            <div style={{marginTop:14,padding:"9px",background:"#0a1a0a",border:"1px solid #39FF1422",borderRadius:8,fontSize:9,color:"#888",textAlign:"center",lineHeight:1.5}}>
              <b style={{color:"#39FF14"}}>Note:</b> Trading terminology stays in English globally. UI labels translate.
            </div>
          </div>
        </div>
      )}
