  ...
  return(
    <div style={PS}>
          ...
          <div>
            ...
            <div style={{margin:"8px 9px",background:"#0d0d0d",border:"1px solid #1a1a1a",borderRadius:14,padding:"10px"}}>
              ...
              <div style={{position:"relative",width:"100%",height:"450px",borderRadius:10,overflow:"hidden",background:"#000"}}>
                <iframe src="https://www.tradingview-widget.com/embed-widget/advanced-chart/?locale=en#%7B%22autosize%22%3Atrue%2C%22symbol%22%3A%22NSE%3ANIFTY50%22%2C%22interval%22%3A%225%22%2C%22timezone%22%3A%22Asia%2FKolkata%22%2C%22theme%22%3A%22dark%22%2C%22style%22%3A%221%22%2C%22locale%22%3A%22en%22%2C%22enable_publishing%22%3Afalse%2C%22hide_top_toolbar%22%3Afalse%2C%22hide_legend%22%3Afalse%2C%22save_image%22%3Afalse%2C%22studies%22%3A%5B%5D%2C%22show_popup_button%22%3Afalse%2C%22popup_width%22%3A%221000%22%2C%22popup_height%22%3A%22650%22%7D" style={{width:"100%",height:"100%",border:"none"}} allowTransparency="true" scrolling="no" allowFullScreen={true}></iframe>
              </div>
              ...
              {oiView==="chart"&&(
                <div style={{background:"#0d0d0d",border:"1px solid #1a1a1a",borderRadius:13,padding:"10px",marginBottom:10}}>
                  ...
                  <div style={{position:"relative",width:"100%",height:"400px",borderRadius:10,overflow:"hidden",background:"#000"}}>
                    <iframe src="https://www.tradingview-widget.com/embed-widget/advanced-chart/?locale=en#%7B%22autosize%22%3Atrue%2C%22symbol%22%3A%22NSE%3ANIFTY50%22%2C%22interval%22%3A%225%22%2C%22timezone%22%3A%22Asia%2FKolkata%22%2C%22theme%22%3A%22dark%22%2C%22style%22%3A%221%22%2C%22locale%22%3A%22en%22%2C%22enable_publishing%22%3Afalse%2C%22hide_top_toolbar%22%3Afalse%2C%22hide_legend%22%3Afalse%2C%22save_image%22%3Afalse%2C%22studies%22%3A%5B%5D%2C%22show_popup_button%22%3Afalse%7D" style={{width:"100%",height:"100%",border:"none"}} allowTransparency="true" scrolling="no"></iframe>
                  </div>
                </div>
              )}
            </div>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,background:"rgba(0,0,0,0.98)",borderTop:"1px solid #0d0d0d",display:"flex",justifyContent:"space-around",padding:"5px 3px 10px",zIndex:100}}>
        {[["home","&#127968;","Home"],["watch","&#11088;","Watch"],["markets","&#128200;","Markets"],["ipo","&#127919;","IPO"],["fii","&#128176;","FII/DII"],["oi","&#128202;","OI"],["news","&#128240;","News"],["learn","&#128218;","Learn"]].concat(isAdmin?[["admin","&#128081;","Admin"]]:[]).map(function(item){
