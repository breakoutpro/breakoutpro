  ...
  return (
    <div style={{display:"flex",alignItems:"center",gap:10,padding:"11px 14px",borderBottom:"1px solid "+BD,cursor:"pointer"}} onClick={props.onClick}>
      <div style={{width:36,height:36,borderRadius:10,background:"rgba(255,255,255,0.04)",border:"1px solid "+BD,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
        <span style={{fontSize:7,fontWeight:800,color:T2}}>{s.sym.slice(0,3)}</span>
      </div>
      <div style={{flex:1}}>
      ...
      <div style={{textAlign:"right",minWidth:80}}>
        ...
        <div style={{background:s.up?"rgba(34,197,94,0.12)":"rgba(239,68,68,0.12)",borderRadius:5,padding:"1px 6px",fontSize:8,fontWeight:700,color:s.up?G2:R,marginTop:2}}>{s.up?"+":""}{s.chgPct.toFixed(2)}%</div>
      </div>
    ...
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:20}}>
      ...
      <div style={{padding:14}}>
        ...
        <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:10,padding:10}}>
          <div style={{fontSize:8,color:WARN}}>Educational only. Commodity prices are indicative. Not investment advice.</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:20}}>
      <div style={{background:CB,padding:"12px 16px",borderBottom:"1px solid "+BD,display:"flex",alignItems:"center",gap:10}}>
        ...
        <div style={{background:up?"rgba(34,197,94,0.12)":"rgba(239,68,68,0.12)",borderRadius:8,padding:"6px 12px"}}>
      ...
      <div style={{padding:14}}>
            ...
            return (
              <div key={st.sym} style={{display:"flex",alignItems:"center",gap:10,padding:"11px 14px",borderBottom:"1px solid "+BD}}>
                <div style={{width:34,height:34,borderRadius:8,background:"rgba(255,255,255,0.04)",border:"1px solid "+BD,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                  <span style={{fontSize:7,fontWeight:800,color:T2}}>{st.sym.slice(0,3)}</span>
                </div>
                <div style={{flex:1}}>
                ...
                <div style={{textAlign:"right",minWidth:76}}>
                  ...
                  <div style={{background:st.up?"rgba(34,197,94,0.12)":"rgba(239,68,68,0.12)",borderRadius:4,padding:"1px 6px",fontSize:8,fontWeight:700,color:st.up?G2:R}}>{st.up?"+":""}{st.chgPct.toFixed(2)}%</div>
                </div>
              </div>
            );
          })}
        ...
        <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:10,padding:10}}>
          <div style={{fontSize:8,color:WARN}}>Educational only. Not investment advice.</div>
        </div>
      </div>
    </div>
  );
