  ...
  return (
    <div style={{padding:"14px 14px 40px"}}>
      ...
      <div style={{display:"flex",gap:8,marginBottom:10}}>
        ...
        <button onClick={shareImg} style={{flex:1,background:"linear-gradient(135deg,#00C853,#00A040)",border:"none",borderRadius:11,padding:"12px",color:"#fff",fontSize:12,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>Share</button>
      </div>
