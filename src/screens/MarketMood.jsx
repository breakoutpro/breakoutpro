...
export default function MarketMood(props){
  ...
  var padV = wideLayout ? "6px 8px" : 10;
  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{background:MT.CARD,borderBottom:"1px solid "+MT.BD,position:"sticky",top:0,zIndex:5}}>
        <div style={{display:"flex",alignItems:"center",gap:10,padding:"6px 12px",maxWidth:1440,margin:"0 auto",boxSizing:"border-box"}}>
      ...
      <div style={{padding:wideLayout?"4px 8px":"10px 12px 16px",maxWidth:1440,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr":undefined,gap:gapV,marginBottom:gapV,alignItems:"start"}}>
          <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:8,padding:padV}}>
            ...
            <div style={{fontSize:11,color:MT.T2}}>{mood.stage} &nbsp;&middot;&nbsp; {mood.confidence} Confidence &nbsp;&middot;&nbsp; AI Score: {mood.score}/100</div>
