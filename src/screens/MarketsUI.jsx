...
import { INDICES } from "../data/marketsMeta";
...
function BackBtn(props) {
  var TH=useTheme().c;
  var DB=TH.bg,CB=TH.card,BD=TH.border,G=TH.up,G2=TH.up,R=TH.down,BLUE=TH.blue,T1=TH.text1,T2=TH.text2,T3=TH.text3,WARN=TH.warn;
  return (
...
function StockRow(props) {
  var TH=useTheme().c;
  var DB=TH.bg,CB=TH.card,BD=TH.border,G=TH.up,G2=TH.up,R=TH.down,BLUE=TH.blue,T1=TH.text1,T2=TH.text2,T3=TH.text3,WARN=TH.warn;
  var s=props.s,spark=genSpark(s.ltp,{points:14,additive:true});
  return (
...
function CommodityDetail(props) {
  ...
  var DB=TH.bg,CB=TH.card,BD=TH.border,G=TH.up,G2=TH.up,R=TH.down,BLUE=TH.blue,T1=TH.text1,T2=TH.text2,T3=TH.text3,WARN=TH.warn;
  var s=props.s;
  var spark=genSpark(s.ltp,{points:14,additive:true});
  return (
      ...
      <div style={{padding:16}}>
        <div style={{background:CB,border:"1px solid "+BD,borderRadius:16,overflow:"hidden",marginBottom:12}}>
          {stocks.map(function(st){
            var sp=genSpark(st.ltp,{points:14,additive:true});
            return (
...
function IndexDetail(props) {
  ...
  var spark=genSpark(idx.ltp,{points:14,additive:true});
  var meta={
