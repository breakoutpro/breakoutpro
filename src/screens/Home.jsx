...
export default function HomeScreen(props) {
  ...
  // Laptop/Desktop/TV: a professional trading workstation must never
  // silently switch to a different Home screen based on time-of-day
  // session logic or a stale admin debug override - always the real
  // Equity workstation. Mobile/Tablet keep the exact existing behavior
  // below, unchanged.
  if(!responsive.isMobile && responsive.breakpoint!="md"){
