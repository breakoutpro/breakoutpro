      ...
      <div style={{padding:14}}>
        ...
        {picked?(
          <div style={{marginTop:14}}>
            ...
            <button onClick={next} style={{width:"100%",background:BLUE,border:"none",borderRadius:10,padding:"13px",color:"#04060D",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>Next Pattern &#8594;</button>
          </div>
        ):null}
      </div>
    </div>
      ...
      <div style={{padding:14}}>
        {done?(
          <div style={{textAlign:"center",padding:"30px 10px"}}>
            ...
            <button onClick={props.onBack} style={{marginTop:18,background:BLUE,border:"none",borderRadius:10,padding:"12px 26px",color:"#04060D",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>Back to Pattern</button>
          </div>
        ):(
          <div>
            ...
            {picked!=null?<button onClick={next} style={{width:"100%",background:BLUE,border:"none",borderRadius:10,padding:"13px",marginTop:6,color:"#04060D",fontSize:13,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>{idx>=QS.length-1?"See Result":"Next"} &#8594;</button>:null}
          </div>
        )}
      </div>
    </div>
