  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{padding:"16px 24px 32px",maxWidth:1440,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        {usingDemo ? (
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr":undefined,gap:wideLayout?16:8,marginBottom:16}}>
        ...
        {usingDemo ? (
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr 1fr":undefined,gap:wideLayout?16:8,marginBottom:16}}>
            <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:14,padding:16,marginBottom:wideLayout?0:8}}>
