      ...
      <div style={{padding:"18px 16px 14px",position:"relative"}}>
        ...
        {t.id=="news"?(
          <div>
            ...
            <div style={{display:"inline-block",background:d.impact=="Bullish"?"rgba(0,200,83,0.15)":d.impact=="Bearish"?"rgba(239,68,68,0.15)":"rgba(245,158,11,0.15)",border:"1px solid "+(d.impact=="Bullish"?G:d.impact=="Bearish"?R:GOLD)+"44",borderRadius:20,padding:"3px 10px"}}>
              <span style={{fontSize:9,fontWeight:700,color:d.impact=="Bullish"?G2:d.impact=="Bearish"?R:GOLD}}>{d.impact||"Neutral"} Impact</span>
            </div>
          </div>
        ):null}
    ...
    return (
      <div style={{background:DB,minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter,sans-serif",padding:20}}>
        <div style={{textAlign:"center"}}>
          ...
          <button onClick={function(){setTab("more");}} style={{background:"rgba(255,255,255,0.06)",border:"1px solid "+BD,borderRadius:10,padding:"10px 20px",color:T1,fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>Go Back</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{background:CB,padding:"12px 14px",borderBottom:"1px solid "+BD}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <button onClick={function(){setTab("more");}} style={{background:"rgba(255,255,255,0.06)",border:"none",borderRadius:8,width:30,height:30,color:T1,fontSize:13,cursor:"pointer",flexShrink:0}}>&#8592;</button>
            <div>
        ...
        <div style={{display:"flex",gap:4}}>
          {["Template","Details","Preview & Share"].map(function(s,i){
            ...
            return <div key={s} style={{flex:1,height:3,background:done?G:act?"rgba(0,200,83,0.5)":BD,borderRadius:2}}></div>;
          })}
        </div>
      </div>
      ...
      <div style={{padding:"12px 14px 0"}}>
        ...
        {msg?<div style={{background:"rgba(0,200,83,0.15)",border:"1px solid rgba(0,200,83,0.3)",borderRadius:10,padding:"10px 14px",marginBottom:10}}><div style={{fontSize:11,color:G2,fontWeight:700}}>{msg}</div></div>:null}
        ...
        {step==1?(
          <div>
            ...
            <button onClick={function(){setStep(2);}} style={{width:"100%",background:G,border:"none",borderRadius:12,padding:13,color:"#fff",fontSize:13,fontWeight:700,cursor:"pointer",fontFamily:"inherit",marginTop:4}}>Next</button>
          </div>
        ):null}
        ...
        {step==3?(
          <div>
            ...
            <div style={{background:"rgba(59,130,246,0.08)",border:"1px solid rgba(59,130,246,0.2)",borderRadius:10,padding:10,marginBottom:12}}>
              <div style={{fontSize:9,fontWeight:700,color:"#3B82F6",marginBottom:2}}>Screenshot for Instagram/YouTube</div>
