...
export function Sparkline(props){
  ...
  var col = lastUp ? MT.SENT_YELLOW : MT.SENT_GREEN; // for VIX, rising = more fear (yellow), falling = calmer (green)
  return (
...
export function SemicircleGauge(props){
  ...
  return (
    <div style={{position:"relative",width:85,height:50}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",width:85,fontSize:6,color:MT.T3,fontWeight:700,marginTop:1}}>
