...
var FRESHNESS_META = {
  ...
  DEMO:        { text:"DEMO DATA",   color:MT.WARN },
...
export function buildIndexRow(name, idxData){
  ...
  var absChange = (idxData.ltp!=null && idxData.prevClose!=null) ? Math.round((idxData.ltp-idxData.prevClose)*100)/100 : null;
  return {
    available:true,
    name:name,
    ...
    prevClose: idxData.prevClose!=null ? formatIndexValue(idxData.prevClose) : null,
    absChange: absChange!=null ? (absChange>=0?"+":"")+formatIndexValue(absChange) : null,
    dayLow: idxData.low!=null ? formatIndexValue(idxData.low) : null,
    dayHigh: idxData.high!=null ? formatIndexValue(idxData.high) : null
  };
}
