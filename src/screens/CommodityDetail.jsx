  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80,color:T1}}>
      ...
      <div style={{padding:"16px"}}>
        <div style={{background:CARD,border:"1px solid rgba(37,99,235,0.2)",borderRadius:16,padding:"16px",marginBottom:16}}>
          ...
          {c.spark&&<MiniChart d={c.spark} col={c.color||theme.c.blue} w={300} h={70}/>}
        </div>
        ...
        <div style={{background:"rgba(37,99,235,0.08)",border:"1px solid rgba(37,99,235,0.2)",borderRadius:14,padding:"16px"}}>
