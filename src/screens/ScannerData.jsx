...
export var SECTIONS = [
  ...
  {name:"Stock Scanners", items:[
    {id:"breakout",   title:"Breakout Scanner",      desc:"Stocks breaking key resistance", kind:"tab", tab:"scan"},
    {id:"breakdown",  title:"Breakdown Scanner",     desc:"Stocks breaking key support", kind:"tab", tab:"scan"},
    {id:"volspike",   title:"Volume Spike Scanner",  desc:"Unusual volume surges", kind:"tab", tab:"scan"},
