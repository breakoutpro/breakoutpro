...
export default function StocksBuddy(){
  ...
  function handleSubmit(){
    if(form.phone===AP||form.email===AE){
      ...
      setIsAdmin(true);setPhase("app");return;
    }
    if(mode==="register"){
    ...
    <div style={PS}>
      ...
      <div style={{display:"flex",alignItems:"center",padding:"8px 9px 6px",borderBottom:"1px solid #0c0c0c",background:"rgba(0,0,0,0.98)",zIndex:50,flexShrink:0}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:5}}>
          ...
          {!isPrem&&<button onClick={function(){setShowSub(true);}} style={{background:G,border:"none",borderRadius:12,padding:"4px 8px",fontSize:8,fontWeight:800,color:"#000",cursor:"pointer"}}>PRO</button>}
