import { getAssetCard, getMarketStatus, parseOptionContract, POPULAR_INDICES } from "./GuardianData";
import { loadWatchlist } from "../hooks/useWatchlist";

// BreakoutPro - HomeGuardianCard.jsx
// Compact AI Market Guardian hero for Home. Watching / Uptrend / Downtrend / Mood.
// Reads the ONE global watchlist (single source of truth). Educational only.
...
export default function HomeGuardianCard(props){
  ...
  var watch=syms.map(function(s){ return {sym:s, type:typeOf(s)}; });
