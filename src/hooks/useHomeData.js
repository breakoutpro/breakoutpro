  ...
  var spineRows = useMemo(function(){
    ...
    return SPINE_INDICES.map(function(s){
      ...
      if(!hasLive){
        ...
        // powers the working Range Intelligence card - fixes the state
        // mismatch where the ticker showed "not available" while Range
        // Intelligence simultaneously showed real calculated values for
        // the same index.
