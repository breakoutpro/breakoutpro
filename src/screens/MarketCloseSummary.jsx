  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:"14px"}}>
        ...
        <div style={{background:theme.c.card,border:"1px solid "+BD,borderRadius:18,padding:"16px",marginBottom:14}}>
        ...
        <div style={{background:theme.c.card,border:"1px solid rgba(124,58,237,0.25)",borderRadius:14,padding:"14px",marginBottom:14}}>
        ...
        <button onClick={function(){setTab("journal");}} style={{width:"100%",background:"rgba(59,130,246,0.12)",border:"1px solid rgba(59,130,246,0.3)",borderRadius:14,padding:"13px",color:BLUE,fontSize:11,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>
          &#128221; Log Today's Trades
        </button>
      </div>
    </div>
