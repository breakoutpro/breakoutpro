...
export default function Guardian(props){
  ...
  return (
    <div style={{background:"#050505",minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:24,textAlign:"center"}}>
        <div style={{maxWidth:320}}>
          <div style={{fontSize:13,color:"#A0A7B4",lineHeight:1.7}}>This feature is being rebuilt with real data - check back soon.</div>
        </div>
      </div>
    </div>
  );
