...
export function getAssetCard(asset){
  ...
  var score=62+(seed%34); // 62-95
  var bias=score>=75?"Bullish":score>=55?"Neutral":"Bearish";
  var up=bias!="Bearish";
...
export function getAssetTimeline(sym){
  return [
    {time:"09:15",type:"breakout"},
    {time:"09:18",type:"rsi"},
    {time:"09:20",type:"volspike"},
    {time:"09:24",type:"oichange"},
    {time:"09:30",type:"bullengulf"},
    {time:"09:34",type:"news"},
    {time:"09:36",type:"pcr"},
    {time:"09:41",type:"resistancebreak"}
  ];
}
