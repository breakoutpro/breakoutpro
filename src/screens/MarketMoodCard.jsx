...
export default function MarketMoodCard(props){
  ...
  var UP=theme.c.up, DOWN=theme.c.down, GOLD=theme.c.gold, BLUE=theme.c.blue, CYAN=theme.c.blue, WARN=theme.c.warn;
        ...
        <div>
          <div style={{display:"flex",alignItems:"center",gap:13,marginBottom:11}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{fontSize:12,color:T2,marginTop:2}}>Stage: {stage}</div>
              <div style={{fontSize:12,color:T3,marginTop:1}}>{openingBias(scoreVal)}</div>
            </div>
          </div>

          <div style={{background:CARD2,borderRadius:10,padding:"9px 11px",marginBottom:9}}>
            <div style={{fontSize:12,color:T3,fontWeight:700,marginBottom:2}}>NOW</div>
            ...
            <div style={{marginBottom:9}}>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:5}}>
                {ai.keyDrivers.map(function(d,i){
                  return <span key={i} style={{fontSize:12,color:T2,background:CARD2,border:"1px solid "+BD,borderRadius:6,padding:"3px 7px"}}>{d}</span>;
                })}
              </div>
            </div>
          ) : null}
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",rowGap:4,marginBottom:9}}>
            <span style={{fontSize:12,color:T3}}>Confidence: <span style={{color:mood.confidence=="High"?UP:mood.confidence=="Low"?DOWN:GOLD,fontWeight:700}}>{mood.confidence}</span></span>
