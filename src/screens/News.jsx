    ...
    <div style={{background:DB, minHeight:"100vh", fontFamily:"Inter,Arial,sans-serif", paddingBottom:80}}>
      ...
      <div style={{padding:"12px 16px 0"}}>
        ...
        {news.map(function(n, i) {
          ...
          return (
            <div key={i} style={{background:CB, border:"1px solid "+BD, borderRadius:16, margin:"8px 0", overflow:"hidden", width:"100%", boxSizing:"border-box"}}>
                ...
                <div style={{display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12}}>
                  <div style={{flex:1}}>
                    <div style={{display:"flex",gap:6,marginBottom:5,flexWrap:"wrap"}}>
                      {n.sentiment=="good"?<span style={{fontSize:12,fontWeight:700,color:"#16A34A",background:"#16A34A18",border:"1px solid #16A34A55",borderRadius:6,padding:"4px 8px",display:"flex",alignItems:"center",gap:4}}><span style={{width:5,height:5,borderRadius:"50%",background:"#16A34A",display:"inline-block"}}></span>BULLISH</span>:null}
                      {n.sentiment=="bad"?<span style={{fontSize:12,fontWeight:700,color:"#DC2626",background:"#DC262618",border:"1px solid #DC262655",borderRadius:6,padding:"4px 8px",display:"flex",alignItems:"center",gap:4}}><span style={{width:5,height:5,borderRadius:"50%",background:"#DC2626",display:"inline-block"}}></span>BEARISH</span>:null}
                      {n.sentiment=="neutral"?<span style={{fontSize:12,fontWeight:700,color:"#EAB308",background:"#EAB30818",border:"1px solid #EAB30855",borderRadius:6,padding:"4px 8px",display:"flex",alignItems:"center",gap:4}}><span style={{width:5,height:5,borderRadius:"50%",background:"#EAB308",display:"inline-block"}}></span>NEUTRAL</span>:null}
                    ...
                    <div style={{fontSize:15, fontWeight:600, color:T1, lineHeight:1.4, marginBottom:5}}>{n.title}</div>
                    <div style={{display:"flex", gap:8, alignItems:"center", flexWrap:"wrap"}}>
                      ...
                      {n.link?<a href={n.link} target="_blank" rel="noopener noreferrer" style={{fontSize:12,color:T2,fontWeight:600,textDecoration:"underline"}}>Read Full Article &#8599;</a>:null}
                    </div>
                  </div>
