  ...
  return (
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{background:MT.CARD,borderBottom:"1px solid "+MT.BD,position:"sticky",top:0,zIndex:5}}>
        <div style={{display:"flex",alignItems:"center",gap:10,padding:wideLayout?"2px 8px":"6px 12px",maxWidth:1600,margin:"0 auto",boxSizing:"border-box"}}>
      ...
      <div style={{padding:wideLayout?"2px 6px":"10px 12px 16px",maxWidth:1600,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr":undefined,gap:gapV,marginBottom:gapV,alignItems:"start"}}>
          <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:8,padding:padV}}>
            ...
            <div style={{fontSize:11,color:MT.T2}}>{mood.stage} &nbsp;&#183;&nbsp; {mood.confidence} Confidence &nbsp;&#183;&nbsp; AI Score: {mood.score}/100</div>
        ...
        <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1.5fr":undefined,gap:gapV,marginBottom:gapV,alignItems:"start"}}>
          ...
          {(function(){
            ...
            if(!anyReal){
              ...
              // look unfinished.
              return (
                <div style={{background:MT.CARD2,border:"1px solid "+MT.BD,borderRadius:8,padding:padV,boxSizing:"border-box",width:"100%"}}>
                  <div style={{fontSize:10,fontWeight:800,color:MT.T2,marginBottom:2}}>MARKET INTELLIGENCE</div>
            ...
            return (
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr":undefined,gap:gapV}}>
          {wideLayout || haveWhy ? (
          <div style={{marginBottom:wideLayout?0:8}}>
        ...
        <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:8,padding:padV,marginBottom:gapV}}>
          <div style={{fontSize:10,fontWeight:800,color:MT.T1,marginBottom:4}}>MARKET SNAPSHOT</div>
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"repeat(auto-fit, minmax(160px, 1fr))":"repeat(2, minmax(0, 1fr))",gap:wideLayout?6:6}}>
            {[["NIFTY", niftyRow], ["BANKNIFTY", bankRow], ["SENSEX", sensexRow], ["GIFTNIFTY", null], ["VIX", vixRow]].map(function(pair,i){
              ...
              return (
                <div key={i} style={{background:MT.CARD2,border:"1px solid "+MT.BD,borderRadius:8,padding:"6px 7px",marginBottom:wideLayout?0:6,boxSizing:"border-box",minWidth:0}}>
                  ...
                  {row.available ? (
                    <div>
                      ...
                      <div style={{fontSize:10,fontWeight:700,color:row.up==null?MT.T2:(row.up?MT.SENT_GREEN:MT.SENT_RED)}}>{row.up==null?"":(row.up?"\u25b2 ":"\u25bc ")}{row.absChange ? row.absChange+" " : ""}({row.chgPct})</div>
                  ...
                  ) : <div style={{fontSize:11,color:MT.T2}}>Data unavailable</div>}
                </div>
              );
            })}
          </div>
        ...
        <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"repeat(4, 1fr)":undefined,gap:gapV,marginBottom:gapV,alignItems:"start"}}>
          ...
          <div style={{background:MT.WARN+"14",border:"1px solid "+MT.WARN+"55",borderRadius:8,padding:padV}}>
