var BG="#07111F",CARD="#101B2E",BD="#1E3A5F",BLUE="#3B82F6",BLUE2="#60A5FA",PURPLE="#7C3AED",GOLD="#F59E0B",UP="#22C55E",DOWN="#EF4444",T1="#FFFFFF",T2="#94A3B8",T3="#475569";
...
var EQ=[
  ...
  {sym:"TCS",       ltp:3654,  base:3654,  sect:"IT"},
  {sym:"HDFCBANK",  ltp:1742,  base:1742,  sect:"Bank"},
  {sym:"ICICIBANK", ltp:1289,  base:1289,  sect:"Bank"},
  {sym:"INFY",      ltp:1567,  base:1567,  sect:"IT"},
  {sym:"SBIN",      ltp:812,   base:812,   sect:"Bank"},
  {sym:"TATAMOTORS",ltp:945,   base:945,   sect:"Auto"},
];
...
export { EQ, CM, PATTERNS, BREAKOUTS, OI_TYPES, SECTORS, ALERT_CATEGORIES, TIMEFRAMES, VOICE_MODES, getSess, genCandle, calcConfidence, riskFromConf, playSound, speakAlert, buildVoiceText, MiniSpark, loadAlertSettings, saveAlertSettings };
