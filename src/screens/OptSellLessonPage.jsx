  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:40}}>
      ...
      <div style={{padding:16}}>
        ...
        {d.formula?(
          <Sec t="KEY FORMULA">
            <div style={{background:CARD2,border:"1px solid "+BD,borderRadius:12,padding:12}}>
        ...
        <Sec t={"QUIZ ("+d.quiz.length+" QUESTIONS)"}>
          ...
          {!showResult?(
            ...
            <div style={{background:score==d.quiz.length?"rgba(34,197,94,0.1)":"rgba(37,99,235,0.1)",border:"1px solid "+(score==d.quiz.length?"rgba(34,197,94,0.3)":"rgba(37,99,235,0.3)"),borderRadius:12,padding:16,textAlign:"center"}}>
