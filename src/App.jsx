          ...
          <div>
            <div style={{margin:"8px 9px",background:"#0d0d0d",border:"1px solid #1a1a1a",borderRadius:14,padding:"10px"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <div>
                  <div style={{fontSize:11,fontWeight:800,color:"#39FF14"}}>NIFTY 50 - 5min Chart</div>
                  <div style={{fontSize:8,color:"#445"}}>Real-time Candlesticks | TradingView</div>
                </div>
              ...
              <div style={{position:"relative",width:"100%",height:"340px",borderRadius:10,overflow:"hidden",background:"#000"}}>
                <iframe src="https://s.tradingview.com/widgetembed/?symbol=NSE%3ANIFTY&interval=5&theme=dark&style=1&timezone=Asia%2FKolkata&locale=en" style={{width:"100%",height:"100%",border:"none"}} frameBorder="0" allowTransparency="true" scrolling="no"></iframe>
              </div>
              <div style={{marginTop:7,padding:"6px 8px",background:"#0a1a0a",border:"1px solid #39FF1422",borderRadius:7,fontSize:8,color:"#aaa",lineHeight:1.5}}>
                <b style={{color:"#39FF14"}}>Educational use only.</b> 5-minute candles with timer. Click chart to change timeframe inside TradingView.
              </div>
            </div>
