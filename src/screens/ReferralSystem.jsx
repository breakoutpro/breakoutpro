  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:"14px"}}>
        ...
        {/* Hero Card */}
        <div style={{background:theme.c.card,border:"1px solid rgba(245,158,11,0.3)",borderRadius:18,padding:"18px",marginBottom:14,textAlign:"center"}}>
                ...
                return (
                  <div key={i} style={{padding:"10px 14px",borderBottom:i<data.invites.length-1?"1px solid rgba(30,42,77,0.5)":"none",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    <div style={{display:"flex",alignItems:"center",gap:10}}>
                      <div style={{width:28,height:28,borderRadius:8,background:""+BLUE+"",display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:700,color:"#fff"}}>{inv.name.charAt(0)}</div>
