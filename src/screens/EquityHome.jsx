...
import HomeSignalCards from "./HomeSignalCards";
...
export default function EquityHome(props){
  ...
  var [indices,setIndices]=useState(function(){var keep=["NIFTY","BANKNIFTY","SENSEX","VIX"];return INDICES.filter(function(x){return keep.indexOf(x.key)!=-1;}).map(function(x){return Object.assign({},x,{spark:genSpark(x.ltp)});});});
  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",paddingBottom:84,color:T1}}>
      ...
      <div style={{marginTop:18}}>
        <OptionsIntel symbol="NIFTY"/>
      </div>

      {/* LEARN AND INVEST */}
      <div style={{marginTop:18}}>
        <HomeLearnCards setTab={setTab}/>
      </div>

      {/* LIVE MARKET NEWS - top 5 clean cards */}
      <div style={{marginTop:18,padding:"0 14px"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
          <span style={{fontSize:14,fontWeight:800,color:T1}}>Live Market News</span>
