...
export default function AddHoldingForm(props){
  ...
  return (
    <div style={{padding:16}}>
      <button onClick={onCancel} style={{background:"none",border:"none",color:BLUE,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit",padding:4,marginBottom:16,minHeight:44}}>&#8592; Cancel</button>
      ...
      <button onClick={submit} style={{width:"100%",background:BLUE,border:"none",borderRadius:12,padding:"12px 24px",color:"#fff",fontSize:16,fontWeight:800,cursor:"pointer",fontFamily:"inherit",marginTop:8,minHeight:44}}>{editing?"Save Changes":"Save Holding"}</button>
    </div>
  );
}
