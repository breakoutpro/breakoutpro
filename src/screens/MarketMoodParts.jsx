...
export function IndexRow(props){
  ...
  if(!row || !row.available){
    return (
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",rowGap:2,padding:"2px 6px",borderBottom:"1px solid "+MT.BD}}>
...
export function StageTimeline(props){
  ...
  if(props.compact){
    return (
      <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:8,padding:6,height:"100%",boxSizing:"border-box",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden",minWidth:0}}>
