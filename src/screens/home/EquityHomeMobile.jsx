          ...
          return (
            <Card title="Key Levels (NIFTY 50)" icon="&#127919;">
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
                ...
                <div><div style={{fontSize:9,color:T3}}>Resistance</div><div style={{fontSize:12,fontWeight:800,color:DOWN}}>{nifty.high.toLocaleString("en-IN")}</div></div>
                ...
                <div><div style={{fontSize:9,color:T3}}>Support</div><div style={{fontSize:12,fontWeight:800,color:UP}}>{nifty.low.toLocaleString("en-IN")}</div></div>
              </div>
              <div style={{marginTop:6}}><div style={{fontSize:9,color:T3}}>Strong Support</div><div style={{fontSize:12,fontWeight:800,color:UP}}>{s1.toLocaleString("en-IN")}</div></div>
            </Card>
          );
        })()}
