...
export default function GlobalHome(props) {
  ...
  return (
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      {/* Header */}
      <div style={{background:"#050816",padding:"14px 16px 12px",borderBottom:"1px solid "+BD}}>
      ...
      <div style={{padding:"12px 14px 0"}}>
        ...
        <div style={{background:"#0A0F1E",border:"1px solid rgba(59,130,246,0.25)",borderRadius:20,padding:"14px 16px",marginBottom:14}}>
        ...
        {/* Tomorrow outlook */}
        <div style={{background:"#050A1A",border:"1px solid rgba(59,130,246,0.2)",borderRadius:20,padding:16,marginBottom:14}}>
