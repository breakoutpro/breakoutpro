...
{/* Gainers/Losers */}
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:12}}>
          <div style={{background:CARD,border:"1px solid "+BD,borderRadius:14,padding:"10px 12px"}}>
            <div style={{fontSize:8,fontWeight:700,color:UP,marginBottom:8}}>TOP GAINERS</div>
          ...
          <div style={{background:CARD,border:"1px solid "+BD,borderRadius:14,padding:"10px 12px"}}>
            <div style={{fontSize:8,fontWeight:700,color:DOWN,marginBottom:8}}>TOP LOSERS</div>
        ...
        <div style={{background:CARD,border:"1px solid "+BD,borderRadius:14,padding:"10px 14px",marginBottom:12}}>
          <div style={{fontSize:8,fontWeight:700,color:T3,marginBottom:8,letterSpacing:0.8}}>SECTOR STRENGTH</div>
