      ...
      <div style={{padding:14}}>
        {!confirmed ? (
          <div style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:14}}>
            ...
            <input value={name} onChange={function(ev){setName(ev.target.value);}} placeholder="Your full name" style={{width:"100%",background:"#0B0E13",border:"1px solid "+BD,borderRadius:10,padding:"11px 12px",color:T1,fontSize:13,fontFamily:"inherit",boxSizing:"border-box",marginBottom:12}}/>
          ...
          <div>
            ...
            <div style={{background:"rgba(249,115,22,0.06)",border:"1px solid rgba(249,115,22,0.15)",borderRadius:10,padding:11,marginTop:14}}>
              <div style={{fontSize:8.5,color:"#F97316",lineHeight:1.5}}>Educational certificate only - confirms Academy module completion within this app. Not a professional or regulatory qualification, not SEBI-registered, not investment advice.</div>
            </div>
          </div>
        )}
      </div>
