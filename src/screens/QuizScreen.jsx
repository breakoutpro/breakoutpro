            ...
            <div>
              ...
              <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                {progress.badges.map(function(b){
                  return <span key={b} style={{background:"rgba(37,99,235,0.12)",border:"1px solid rgba(37,99,235,0.3)",borderRadius:8,padding:"4px 12px",fontSize:12,fontWeight:700,color:BLUE}}>{b}</span>;
                })}
              </div>
            </div>
          ):null}
    ...
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:32}}>
      <div style={{background:CB,padding:"12px 16px",borderBottom:"1px solid "+BD}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
          ...
          <div style={{background:"rgba(37,99,235,0.12)",borderRadius:10,padding:"4px 12px"}}>
