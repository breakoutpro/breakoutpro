...
export default function EquityHome(props){
  ...
  var TICKER=["NIFTY testing 24,050 resistance","FII net buyers 8th session","Banking sector leads rally","IT stocks outperform Q4"];
      ...
      <div style={{padding:"16px 16px 10px"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <div style={{width:34,height:34,borderRadius:10,background:"linear-gradient(135deg,#1E3A8A,#1D4ED8)",border:"1px solid "+CARDBORDER,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
          ...
          <button onClick={function(){setTab("profile");}} style={{width:36,height:36,borderRadius:"50%",background:"linear-gradient(135deg,"+BLUE+",#6366F1)",border:"2px solid "+CARDBORDER,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0}}>
        ...
        <div onClick={function(){setTab("search");}} style={{display:"flex",alignItems:"center",gap:8,background:"#111318",border:"1px solid rgba(255,255,255,0.08)",borderRadius:12,padding:"9px 14px",cursor:"pointer",marginBottom:10}}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#5B6472" strokeWidth="2.5" strokeLinecap="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
