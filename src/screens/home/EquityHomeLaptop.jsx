            ...
            <table style={{width:"100%",borderCollapse:"collapse",tableLayout:"fixed"}}>
              <thead>
                <tr style={{borderBottom:"1px solid "+BD2}}>
                  <th style={{width:"34%",textAlign:"left",fontSize:tierCfg.label,color:T3,fontWeight:700,padding:"4px 4px"}}>STOCK</th>
                  <th style={{width:"22%",textAlign:"right",fontSize:tierCfg.label,color:T3,fontWeight:700,padding:"4px 4px"}}>PRICE</th>
                  <th style={{width:"22%",textAlign:"right",fontSize:tierCfg.label,color:T3,fontWeight:700,padding:"4px 4px"}}>CHG%</th>
                  <th style={{width:"22%",textAlign:"right",fontSize:tierCfg.label,color:T3,fontWeight:700,padding:"4px 4px"}}>CONFIDENCE</th>
                </tr>
              </thead>
              <tbody>
