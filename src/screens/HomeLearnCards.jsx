    ...
    <div style={{padding:"6px 0 0"}}>
      ...
      <div style={{display:"flex",gap:8,overflowX:"auto",padding:"0 14px 4px",WebkitOverflowScrolling:"touch"}}>
        {LEARN_CARDS.map(function(c){
          return (
            <div key={c.id} onClick={function(){setTab("learn");}} style={{background:CARD,border:"1px solid "+BD,borderRadius:11,padding:"11px 12px",minWidth:104,flexShrink:0,cursor:"pointer"}}>
