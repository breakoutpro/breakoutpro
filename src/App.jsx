    ...
    <div style={Object.assign({},PS,{overflowY:"auto"})}>
      ...
      {otpSt==="form"&&<div style={{padding:"14px 18px 32px"}}>
        ...
        <div style={{marginTop:16}}>
          <div style={{fontSize:9,color:"#2a2a2a",fontWeight:600,letterSpacing:1,marginBottom:8,textAlign:"center"}}>SELECT YOUR LANGUAGE</div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:4}}>
            {Object.entries(LANGS).map(function(kl){return(<button key={kl[0]} onClick={function(){setLang(kl[0]);}} style={{background:lang===kl[0]?"#39FF1418":"#0d0d0d",border:"1.5px solid "+(lang===kl[0]?"#39FF14":"#1a1a1a"),borderRadius:9,padding:"5px 2px",cursor:"pointer",textAlign:"center"}}><div style={{fontSize:8,fontWeight:700,color:lang===kl[0]?"#39FF14":"#334"}}>{kl[1]}</div></button>);})}
          </div>
        </div>
