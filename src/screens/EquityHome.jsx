        ...
        <div style={{background:CARD,border:"1px solid "+BD,borderRadius:16,overflow:"hidden"}}>
          <div style={{padding:"8px 12px",borderBottom:"1px solid "+BD,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <div style={{display:"flex",alignItems:"center",gap:6}}>
              ...
              <span style={{fontSize:8,color:T2}}>NSE Live Chart</span>
            </div>
            <span style={{fontSize:8,color:BLUE2,fontWeight:600}}>TradingView</span>
          </div>
          <div style={{height:300}}>
            <iframe
              src={"https://s.tradingview.com/widgetembed/?frameElementId=tv_chart&symbol=NSE%3ANIFTY&interval=D&hidesidetoolbar=1&hidetoptoolbar=1&symboledit=1&saveimage=0&toolbarbg="+encodeURIComponent("#101B2E")+"&studies=%5B%5D&theme=dark&style=1&timezone=Asia%2FKolkata&studies_overrides=%7B%7D&overrides=%7B%7D&enabled_features=%5B%5D&disabled_features=%5B%5D&locale=en&utm_source=breakoutpro.in"}
