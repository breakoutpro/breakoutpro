    ...
    <div style={{padding:16}}>
      ...
      {!showQuiz ? (
        ...
        <div>
          ...
          {!submitted ? (
            <button onClick={submit} style={{width:"100%",background:UP,border:"none",borderRadius:12,padding:"12px 24px",color:"#fff",fontSize:14,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>{at("submit",lang)}</button>
          ) : (
            <div>
