...
export default function EquityHomeV2(props){
  ...
  function SummaryCard(p){
    return (
      <div style={{background:CARD,border:"1px solid "+(p.hero?BLUE:BD),borderRadius:16,padding:p.hero?18:16,height:"100%",display:"flex",flexDirection:"column",boxSizing:"border-box"}}>
  ...
  return (
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",paddingBottom:84,color:T1}}>
            ...
            return (
              <div style={{display:"grid",gridTemplateColumns:responsive.isMobile?"repeat(2, 1fr)":"repeat(4, 1fr)",gap:10}}>
                {rows.map(function(r){
                  ...
                  return (
                    <div key={r.key} style={{background:theme.c.card2,border:"1px solid "+BD,borderRadius:12,padding:12}}>
                      <div style={{fontSize:11,color:T2,marginBottom:3,fontWeight:600}}>{r.label}</div>
                      <div style={{fontSize:16,fontWeight:900,color:T1,fontFamily:"monospace",marginBottom:2}}>{r.ltp.toLocaleString("en-IN",{maximumFractionDigits:2})}</div>
      ...
      <div style={{display:"grid",gridTemplateColumns:responsive.isMobile?"1fr":"repeat(auto-fit, minmax(300px, 1fr))",gap:16,padding:"16px 14px 0"}}>
        ...
        <div style={{gridColumn:responsive.isMobile?"auto":"span 2"}}>
        ...
        <div style={{background:CARD,border:"1px solid "+BD,borderRadius:16,overflow:"hidden",height:"100%",boxSizing:"border-box"}}>
