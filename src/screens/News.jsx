    ...
    <div style={{background:DB, minHeight:"100vh", fontFamily:"Inter,Arial,sans-serif", paddingBottom:80}}>
      ...
      <div style={{padding:"12px 16px 0"}}>
        ...
        {news.map(function(n, i) {
          ...
          return (
            <div key={i} style={{background:CB, border:"1px solid "+BD, borderRadius:16, margin:"6px 0", overflow:"hidden"}}>
              ...
              <div style={{padding:"10px 14px"}}>
                <div style={{display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12}}>
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:12, fontWeight:700, color:T1, lineHeight:1.4, marginBottom:5}}>{n.title}</div>
