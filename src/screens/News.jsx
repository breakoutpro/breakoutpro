      ...
      <div style={{background:CB, padding:"16px 16px", borderBottom:"1px solid "+BD}}>
        <div style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
          ...
          <div style={{display:"flex", gap:8}}>
            <button onClick={function(){setTab&&setTab("newsstudio");}} style={{background:"rgba(212,175,55,0.15)",border:"1px solid rgba(212,175,55,0.3)",borderRadius:20,padding:"4px 12px",color:theme.c.gold,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>AI News Studio</button>
            {isAdmin?(
                ...
                <div style={{display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:12}}>
                  <div style={{flex:1}}>
                    <div style={{display:"flex",gap:8,marginBottom:8,flexWrap:"wrap"}}>
                      ...
                      {n.stock?<span style={{fontSize:12,fontWeight:700,color:BLUE,background:"rgba(245,158,11,0.15)",borderRadius:6,padding:"4px 8px"}}>{n.stock}</span>:null}
                    </div>
