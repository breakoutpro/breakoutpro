    ...
    <div style={{background:DB,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{padding:"12px 14px 0"}}>
        ...
        <div style={{background:CB,border:"1px solid "+BD,borderRadius:16,padding:14,marginBottom:14}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            {[["US 10Y Bond","4.28%","Yield",GOLD],["Dollar Index","104.23","DXY",BLUE],["Crude Oil","$82.40/bbl","WTI","#78716C"],["Gold","$2,312/oz","COMEX",GOLD],["VIX","14.2","Fear Index",G2],["Crypto BTC","$67,234","Bitcoin","#F97316"]].map(function(r){
