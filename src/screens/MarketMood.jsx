...
import {
  ...
  SemicircleGauge, StageTimeline, EvolutionCard, Sparkline, buildMT
    ...
    <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:MT.BG,zIndex:350,overflowY:"auto"}}>
      ...
      <div style={{padding:wideLayout?"4px 10px":"16px 24px 32px",maxWidth:1440,margin:"0 auto",width:"100%",boxSizing:"border-box"}}>
        ...
        <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"1fr 1fr":undefined,gap:gapV,marginBottom:gapV,alignItems:"start"}}>
          <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:10,padding:padV,marginBottom:wideLayout?0:gapV,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,flexWrap:"wrap"}}>
            ...
            <div style={{textAlign:"right",flexShrink:0}}>
              <div style={{fontSize:9,color:MT.T3,fontWeight:700}}>AI BIAS</div>
              <div style={{fontSize:14,fontWeight:900,color:moodColor}}>{mood.label}</div>
            </div>
          </div>
        ...
        <div style={{background:MT.CARD,border:"1px solid "+MT.BD,borderRadius:14,padding:padV,marginBottom:gapV}}>
          ...
          <div style={{display:wideLayout?"grid":"block",gridTemplateColumns:wideLayout?"repeat(4, 1fr)":undefined,gap:wideLayout?8:8}}>
