    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"'Inter',Arial,sans-serif",color:T1,overflowX:"hidden",display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,display:"flex",minHeight:0,width:"100%"}}>
        ...
        <div style={{flex:1,minWidth:0,padding:"12px 16px",overflowY:"auto"}}>
          ...
          {/* Row 2: Scanner Summary - full width, compacted per explicit request */}
          <div style={{background:CARD2,border:"1px solid "+BD,borderRadius:10,padding:Math.max(8,tierCfg.cardPadding-4),marginBottom:tierCfg.gridGap}}>
          ...
          <div style={{background:CARD2,border:"1px solid "+BD,borderRadius:10,padding:tierCfg.cardPadding,marginBottom:tierCfg.gridGap,height:tierCfg.keyLevelsHeight,boxSizing:"border-box",display:"flex",flexDirection:"column"}}>
