...
export default function PulseOverview(){
  ...
  return (
    <div>
      ...
      {/* AI CONCLUSION */}
      <div style={{background:"#071019",border:"1px solid rgba(59,130,246,0.15)",borderRadius:18,padding:16,marginBottom:16}}>
        ...
        <div style={{fontSize:12,color:"#D4D8E0",lineHeight:1.75}}>{ai.message}</div>
      </div>
          ...
          return (
            <div key={l.name} style={{marginBottom:12}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
                ...
                <div style={{background:"#052E16",border:"1px solid "+G2,borderRadius:12,padding:"12px 12px"}}>
