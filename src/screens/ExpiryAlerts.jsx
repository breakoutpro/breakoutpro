...
export default function ExpiryAlerts(props){
  ...
  var BD2 = theme.c.border2, BG = theme.c.bg, CARD = theme.c.card, CARD2 = theme.c.card2, BLUE = theme.c.gold, T2 = theme.c.text2, T3 = theme.c.text3, T2 = theme.c.warn; T1=theme.c.text1; UP=theme.c.up;
