  ...
  return (
    <div style={{position:"relative",width:100,height:56}}>
      <svg width="100" height="50" viewBox="0 0 100 50">
        <path d="M 8.0 50.0 A 42 42 0 0 1 29.0 13.6" stroke={MT.RED} strokeWidth="8" fill="none" strokeLinecap="round"/>
        <path d="M 29.0 13.6 A 42 42 0 0 1 71.0 13.6" stroke={MT.WARN} strokeWidth="8" fill="none"/>
        <path d="M 71.0 13.6 A 42 42 0 0 1 92.0 50.0" stroke={MT.GREEN} strokeWidth="8" fill="none" strokeLinecap="round"/>
        <g transform={"rotate("+needleRot+" 50 50)"}>
          <line x1="50" y1="50" x2="14" y2="50" stroke={MT.T1} strokeWidth="2" strokeLinecap="round"/>
        </g>
        <circle cx="50" cy="50" r="3" fill={MT.T1}/>
      </svg>
      <div style={{display:"flex",justifyContent:"space-between",width:100,fontSize:7,color:MT.T3,fontWeight:700,marginTop:1}}>
