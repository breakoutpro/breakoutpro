...
var BG="#07111F",CARD="#101B2E",BD="#1E3A5F",BLUE="#3B82F6",BLUE2="#60A5FA",PURPLE="#7C3AED",PURPLE2="#A855F7",GOLD="#F59E0B",UP="#1B5E20",DOWN="#EF4444",T1="#FFFFFF",T2="#94A3B8",T3="#475569";
...
export default function Watchlist(props) {
  ...
  var BLUE=theme.c.blue, BLUE2=theme.c.blue, PURPLE="#7C3AED", PURPLE2="#A855F7", GOLD=theme.c.gold;
    ...
    <div style={{background:BG,minHeight:"100vh",fontFamily:"Inter,Arial,sans-serif",paddingBottom:80}}>
      ...
      <div style={{background:CARD,padding:"12px 14px",borderBottom:"1px solid "+BD}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <button onClick={function(){setShowAdd(true);}} style={{background:"transparent",border:"1px solid "+BLUE,borderRadius:10,padding:"8px 14px",color:BLUE,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>+ Add</button>
        </div>
      </div>
      ...
      <div style={{padding:"12px 14px 0"}}>
        ...
        {/* Add stock panel */}
        {showAdd?(
          <div style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:"12px 14px",marginBottom:12}}>
        ...
        {/* Watchlist items */}
        {stocks.length==0?(
          <div style={{background:CARD,border:"1px solid "+BD,borderRadius:12,padding:"40px 20px",textAlign:"center"}}>
            <div style={{fontSize:12,fontWeight:700,color:T1,marginBottom:6}}>Watchlist Empty</div>
            <div style={{fontSize:12,color:T2,marginBottom:14}}>Add stocks, indices, or commodities to track them here</div>
            <button onClick={function(){setShowAdd(true);}} style={{background:"transparent",border:"1px solid "+BLUE,borderRadius:10,padding:"10px 18px",color:BLUE,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit"}}>+ Add Your First Stock</button>
          </div>
        ):(
          <div>
