          ...
          <div>
            ...
            <div style={{padding:"10px 9px 6px"}}>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,background:"#0a0a0a",padding:4,borderRadius:11,border:"1px solid #1a1a1a"}}>
                <button onClick={function(){setOiView("chain");}} style={{background:oiView==="chain"?"linear-gradient(135deg,#39FF14,#00aa00)":"transparent",color:oiView==="chain"?"#000":"#888",border:"none",borderRadius:9,padding:"10px",fontSize:11,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>⛓ Options Chain</button>
                <button onClick={function(){setOiView("chart");}} style={{background:oiView==="chart"?"linear-gradient(135deg,#39FF14,#00aa00)":"transparent",color:oiView==="chart"?"#000":"#888",border:"none",borderRadius:9,padding:"10px",fontSize:11,fontWeight:800,cursor:"pointer",fontFamily:"inherit"}}>📊 Live Chart</button>
              </div>
            </div>
